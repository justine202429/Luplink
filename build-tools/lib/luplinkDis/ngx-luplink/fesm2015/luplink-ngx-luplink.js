import { ɵɵgetCurrentView, ɵɵelementStart, ɵɵtext, ɵɵelementEnd, ɵɵlistener, ɵɵrestoreView, ɵɵnextContext, ɵɵelement, ɵɵadvance, ɵɵtextInterpolate, ɵɵpropertyInterpolate1, ɵɵproperty, ɵɵprojection, ɵɵdefineComponent, ɵɵprojectionDef, ɵɵtemplate, ɵsetClassMetadata, Component, Input, ɵɵdefineNgModule, ɵɵdefineInjector, ɵɵsetNgModuleScope, NgModule, ɵɵdefineInjectable, Injectable, InjectionToken, ɵɵinject, Inject, ɵɵtextInterpolate1, ɵɵpropertyInterpolate, ɵɵpureFunction1, ɵɵsanitizeUrl, EventEmitter, ɵɵdirectiveInject, Output, ɵɵpureFunction0, ɵɵpureFunction2, ɵɵnamespaceSVG, ɵɵnamespaceHTML, ɵɵpipe, ɵɵtextInterpolate2, ɵɵpipeBind1, ChangeDetectorRef, ChangeDetectionStrategy, ɵɵviewQuery, ɵɵqueryRefresh, ɵɵloadQuery, ViewChild, ɵɵelementContainerStart, ɵɵelementContainerEnd, ɵɵpipeBind2, ɵɵsanitizeHtml, ɵɵreference } from '@angular/core';
import { NgClass, NgIf, CommonModule, NgForOf, JsonPipe, DecimalPipe } from '@angular/common';
import { FaIconComponent, FontAwesomeModule } from '@fortawesome/angular-fontawesome';
import { faAngleDown, faQuestionCircle, faEnvelope, faCheck, faExclamation, faCheckCircle, faExclamationTriangle, faTimesCircle, faFileDownload, faAngleLeft, faPencilAlt } from '@fortawesome/free-solid-svg-icons';
import { FormControl, FormGroup, Validators, FormBuilder, ɵangular_packages_forms_forms_ba, NgControlStatusGroup, FormGroupDirective, FormGroupName, DefaultValueAccessor, NgControlStatus, FormControlName, SelectControlValueAccessor, NgSelectOption, ɵangular_packages_forms_forms_z, ReactiveFormsModule, FormsModule, NumberValueAccessor, FormArrayName, CheckboxControlValueAccessor, NgModel } from '@angular/forms';
...
import { RouterLinkWithHref, RouterLinkActive, ActivatedRoute, RouterModule, RouterOutlet } from '@angular/router';
import { trigger, transition, style, animate } from '@angular/animations';
import { select, scaleLinear, extent, line, axisLeft } from 'd3';
import { ɵc, KatexModule } from 'ng-katex';
import { catchError } from 'rxjs/operators';
import { HttpClient, HttpClientModule } from '@angular/common/http';
import sanitize from 'sanitize-filename';
import { ɵd, ɵg, NgxNanospaceClientLibModule, NanospaceService, NanospaceRequestService } from 'ngx-nanospace-client-lib';

function CardComponent_header_1_Template(rf, ctx) { if (rf & 1) {
    const _r3 = ɵɵgetCurrentView();
    ɵɵelementStart(0, "header", 3);
    ɵɵelementStart(1, "p", 4);
    ɵɵtext(2);
    ɵɵelementEnd();
    ɵɵelementStart(3, "a", 5);
    ɵɵlistener("click", function CardComponent_header_1_Template_a_click_3_listener() { ɵɵrestoreView(_r3); const ctx_r2 = ɵɵnextContext(); return ctx_r2.collapseCard(); });
    ɵɵelementStart(4, "span", 6);
    ɵɵelement(5, "fa-icon", 7);
    ɵɵelementEnd();
    ɵɵelementEnd();
    ɵɵelementEnd();
} if (rf & 2) {
    ...
    ɵɵadvance(3);
    ɵɵpropertyInterpolate1("transform", "rotate-", ctx_r0.collapsed ? 0 : 180, "");
    ɵɵproperty("icon", ctx_r0.faAngleDown);
} }
...
CardModule.ɵinj = ɵɵdefineInjector({ imports: [[
            CommonModule,
            FontAwesomeModule,
        ]] });
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵɵsetNgModuleScope(CardModule, { declarations: [CardComponent], imports: [CommonModule,
        FontAwesomeModule], exports: [CardComponent] }); })();
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵsetClassMetadata(CardModule, [{
        type: NgModule,
        args: [{
                declarations: [
                    CardComponent,
...
class FormControlWarn extends FormControl {
}
...
CustomValidators.ɵprov = ɵɵdefineInjectable({ token: CustomValidators, factory: CustomValidators.ɵfac, providedIn: 'root' });
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵsetClassMetadata(CustomValidators, [{
        type: Injectable,
        args: [{
                providedIn: 'root',
            }]
 ...
 */
const FORM_TEMPLATE_TOKEN = new InjectionToken('FormTemplate');
const ENVIRONMENT_TOKEN = new InjectionToken('environment');
...
LoggerService.ɵfac = function LoggerService_Factory(t) { return new (t || LoggerService)(ɵɵinject(ToastrService)); };
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵsetClassMetadata(LoggerService, [{
    ...
    }], function () { return [{ type: ToastrService }]; }, null); })();
...
FormService.ɵfac = function FormService_Factory(t) { return new (t || FormService)(ɵɵinject(FORM_TEMPLATE_TOKEN), ɵɵinject(FormBuilder), ɵɵinject(CustomValidators), ɵɵinject(LoggerService)); };
FormService.ɵprov = ɵɵdefineInjectable({ token: FormService, factory: FormService.ɵfac, providedIn: 'root' });
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵsetClassMetadata(FormService, [{
        type: Injectable,
        args: [{
                providedIn: 'root',
            }]
            ...
            }] }, { type: FormBuilder }, { type: CustomValidators }, { type: LoggerService }]; }, null); })();
...
function FormComponent_div_3_span_6_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵɵadvance(1);
    ɵɵproperty("icon", ctx_r3.faInterrogation);
} }
function FormComponent_div_3_span_10_option_2_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵɵadvance(1);
    ɵɵtextInterpolate1(" ", unit_r9, " ");
} }
function FormComponent_div_3_span_10_Template(rf, ctx) { if (rf & 1) {
    ɵɵelementStart(0, "span", 17);
    ɵɵelementStart(1, "select", 18);
    ɵɵtemplate(2, FormComponent_div_3_span_10_option_2_Template, 2, 1, "option", 3);
    ɵɵelementEnd();
    ɵɵelementEnd();
} if (rf & 2) {
    ...
    ɵɵadvance(1);
    ɵɵpropertyInterpolate("value", ctx_r4.asField(field_r2).units[0]);
    ɵɵadvance(1);
    ɵɵproperty("ngForOf", ctx_r4.asField(field_r2).units);
} }
function FormComponent_div_3_a_11_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵɵadvance(1);
    ɵɵtextInterpolate1(" ", ctx_r5.asField(field_r2).units[0], " ");
} }
function FormComponent_div_3_p_12_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵɵadvance(1);
    ɵɵtextInterpolate1(" ", ctx_r6.getErrorMessage(ctx_r6.localForm.get(field_r2.id)).error, " ");
} }
function FormComponent_div_3_p_13_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵɵadvance(1);
    ɵɵtextInterpolate1(" ", ctx_r7.getWarningMessage(ctx_r7.asFormWarn(ctx_r7.localForm.get(field_r2.id))), " ");
} }
const _c0$1 = function (a0) { return { "is-danger": a0 }; };
function FormComponent_div_3_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵɵtext(5);
    ɵɵtemplate(6, FormComponent_div_3_span_6_Template, 2, 1, "span", 7);
    ɵɵelementEnd();
    ɵɵelementStart(7, "div", 8);
    ɵɵelementStart(8, "div", 9);
    ɵɵelement(9, "input", 10);
    ɵɵelementEnd();
    ɵɵtemplate(10, FormComponent_div_3_span_10_Template, 3, 2, "span", 11);
    ɵɵtemplate(11, FormComponent_div_3_a_11_Template, 2, 1, "a", 12);
    ɵɵelementEnd();
    ɵɵtemplate(12, FormComponent_div_3_p_12_Template, 2, 1, "p", 13);
    ɵɵtemplate(13, FormComponent_div_3_p_13_Template, 2, 1, "p", 14);
    ɵɵelementEnd();
    ɵɵelementEnd();
    ɵɵelementEnd();
    ɵɵelementEnd();
    ...
    let tmp_7_0 = null;
    ɵɵadvance(5);
    ɵɵtextInterpolate1("", ctx_r0.asField(field_r2).desc, ": ");
    ɵɵadvance(1);
    ɵɵproperty("ngIf", field_r2.type === "loss");
    ɵɵadvance(1);
    ɵɵpropertyInterpolate("formGroupName", field_r2.id);
    ɵɵadvance(2);
    ɵɵproperty("ngClass", ɵɵpureFunction1(8, _c0$1, !((tmp_3_0 = ctx_r0.localForm.get(field_r2.id)) == null ? null : tmp_3_0.valid)));
    ɵɵadvance(1);
    ɵɵproperty("ngIf", ctx_r0.asField(field_r2).units.length > 1);
    ɵɵadvance(1);
    ɵɵproperty("ngIf", ctx_r0.asField(field_r2).units.length == 1);
    ɵɵadvance(1);
    ɵɵproperty("ngIf", !((tmp_6_0 = ctx_r0.localForm.get(field_r2.id)) == null ? null : tmp_6_0.valid));
    ɵɵadvance(1);
    ɵɵproperty("ngIf", (tmp_7_0 = ctx_r0.localForm.get(field_r2.id)) == null ? null : tmp_7_0.valid);
} }
function FormComponent_div_4_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵɵadvance(1);
    ɵɵpropertyInterpolate("src", ctx_r1.displayedImage, ɵɵsanitizeUrl);
} }
class FormComponent {
...
LoggerModule.ɵmod = ɵɵdefineNgModule({ type: LoggerModule });
LoggerModule.ɵinj = ɵɵdefineInjector({ providers: [
        LoggerService,
    ], imports: [[
            CommonModule,
...
FormModule.ɵinj = ɵɵdefineInjector({ providers: [
        FormService,
        LoggerService,
    ], imports: [[
            CommonModule,
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵɵsetNgModuleScope(FormModule, { declarations: [FormComponent], imports: [CommonModule,
        ReactiveFormsModule,
        FontAwesomeModule, LoggerModule], exports: [FormComponent] }); })();
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵsetClassMetadata(FormModule, [{
        type: NgModule,
        args: [{
                declarations: [
                    FormComponent,
...
const _c0$2 = function () { return { component: "ULCarrier" }; };
const _c1 = function (a0) { return { "is-active": a0 }; };
const _c2 = function () { return { component: "ULTransmitter" }; };
const _c3 = function () { return { component: "ULReceiver" }; };
function NavigationSidebarComponent_ul_18_Template(rf, ctx) { if (rf & 1) {
    ɵɵelementStart(0, "ul", 3);
    ɵɵelementStart(1, "li");
    ɵɵelementStart(2, "a", 6);
    ɵɵtext(3, "Carrier & Environment");
    ɵɵelementEnd();
    ɵɵelementEnd();
    ɵɵelementStart(4, "li");
    ɵɵelementStart(5, "a", 6);
    ɵɵtext(6, "Transmitter");
    ɵɵelementEnd();
    ɵɵelementEnd();
    ɵɵelementStart(7, "li");
    ...
    const ctx_r0 = ɵɵnextContext();
    ɵɵadvance(2);
    ɵɵproperty("queryParams", ɵɵpureFunction0(6, _c0$2))("ngClass", ɵɵpureFunction1(7, _c1, ctx_r0.currentComponent === "ULCarrier"));
    ɵɵadvance(3);
    ɵɵproperty("queryParams", ɵɵpureFunction0(9, _c2))("ngClass", ɵɵpureFunction1(10, _c1, ctx_r0.currentComponent === "ULTransmitter"));
    ɵɵadvance(3);
    ɵɵproperty("queryParams", ɵɵpureFunction0(12, _c3))("ngClass", ɵɵpureFunction1(13, _c1, ctx_r0.currentComponent === "ULReceiver"));
} }
const _c4 = function () { return { component: "DLCarrier" }; };
const _c5 = function () { return { component: "DLTransmitter" }; };
const _c6 = function () { return { component: "DLReceiver" }; };
function NavigationSidebarComponent_ul_25_Template(rf, ctx) { if (rf & 1) {
    ɵɵelementStart(0, "ul", 3);
    ɵɵelementStart(1, "li");
    ɵɵelementStart(2, "a", 6);
    ɵɵtext(3, "Carrier & Environment");
    ...
    const ctx_r1 = ɵɵnextContext();
    ɵɵproperty("@panelInOut", undefined);
    ɵɵadvance(2);
    ɵɵproperty("queryParams", ɵɵpureFunction0(7, _c4))("ngClass", ɵɵpureFunction1(8, _c1, ctx_r1.currentComponent === "DLCarrier"));
    ɵɵadvance(3);
    ɵɵproperty("queryParams", ɵɵpureFunction0(10, _c5))("ngClass", ɵɵpureFunction1(11, _c1, ctx_r1.currentComponent === "DLTransmitter"));
    ɵɵadvance(3);
    ɵɵproperty("queryParams", ɵɵpureFunction0(13, _c6))("ngClass", ɵɵpureFunction1(14, _c1, ctx_r1.currentComponent === "DLReceiver"));
} }
const _c7 = function () { return { component: "geometry" }; };
const _c8 = function (a0) { return { "fa-rotate-90": a0 }; };
...
NavigationSidebarComponent.ɵcmp = ɵɵdefineComponent({ type: NavigationSidebarComponent, selectors: [["lib-navigation-sidebar"]], inputs: { currentComponent: "currentComponent" }, decls: 85, vars: 25, consts: [["id", "sidebar", 1, "column", "is-narrow", "is-fullheight", "p-0", "m-0", 3, "ngClass"], [1, "section", "pr-0", "pl-0"], [1, "menu"], [1, "menu-list"], ["routerLink", "/luplink/welcome", "href", "#", "routerLinkActive", "is-active", 1, "navbar-menu"], [1, "menu-label"], ["routerLink", "/luplink", 1, "navbar-menu", 3, "queryParams", "ngClass"], [1, "icon", 2, "float", "right", 3, "click"], [3, "icon", "ngClass"], ["class", "menu-list", 4, "ngIf"], ["routerLink", "/luplink/results", "href", "#", "routerLinkActive", "active-route", 1, "navbar-menu", 3, "ngClass"], [1, "navbar-menu", 2, "bottom", "0px", "position", "relative", "right", "0px", 3, "click"], ["id", "modal", 1, "modal", 3, "ngClass"], [1, "modal-background", 3, "click"], [1, "modal-content"], [1, "box"], [2, "display", "inline-block", "margin", "0px"], [1, "has-text-grey", 2, "display", "inline-block", "margin-left", "5px"], ["href", "https://www.gnu.org/licenses/agpl-3.0-standalone.html", 1, "has-text-grey", 2, "display", "block", "margin-bottom", "15px"], [1, "media"], [1, "media-content"], [1, "content"], ["target", "_blank", "href", "https://gitlab.isae-supaero.fr/jsatorb-dev/stage/stage-2021-julien_prissimitzis", 1, "has-text-link"], ["target", "_blank", "href", "https://www.npmjs.com/package/@luplink/ngx-luplink", 1, "has-text-link"], ["target", "_blank", "href", "https://gitlab.com/librecube/lib/python-linkpredict/-/blob/master/README.md", 1, "has-text-link"], ["target", "_blank", "href", "mailto:julienprissi@protonmail.com"], [3, "icon"], [1, "logos"], ["target", "_blank", "href", "https://angular.io/"], ["src", "/assets/images/angular.png", "alt", "logo angular"], ["target", "_blank", "href", "https://www.isae-supaero.fr/fr/"], ["src", "/assets/images/isae.png", "alt", "logo isae"], ["target", "_blank", "href", "http://nanostarproject.eu/"], ["src", "data:image/png;base64,", "alt", "logo nanostar"], ["aria-label", "close", 1, "modal-close", "is-large", 3, "click"], [1, "button", "is-primary", 2, "left", "10px", "z-index", "1", "bottom", "10px", "position", "fixed", 3, "click"]], template: function NavigationSidebarComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        ɵɵlistener("click", function NavigationSidebarComponent_Template_span_click_14_listener() { return ctx.collapseUplink = !ctx.collapseUplink; });
        ɵɵelement(15, "fa-icon", 8);
        ɵɵelementEnd();
        ɵɵtext(16, " Uplink");
        ɵɵelementEnd();
        ɵɵelementEnd();
        ɵɵelementStart(17, "li");
        ɵɵtemplate(18, NavigationSidebarComponent_ul_18_Template, 10, 15, "ul", 9);
        ɵɵelementEnd();
        ɵɵelementStart(19, "li");
        ɵɵelementStart(20, "a");
        ɵɵelementStart(21, "span", 7);
        ɵɵlistener("click", function NavigationSidebarComponent_Template_span_click_21_listener() { return ctx.collapseDownlink = !ctx.collapseDownlink; });
        ɵɵelement(22, "fa-icon", 8);
        ɵɵelementEnd();
        ɵɵtext(23, "Downlink ");
        ɵɵelementEnd();
        ɵɵelementEnd();
        ɵɵelementStart(24, "li");
        ɵɵtemplate(25, NavigationSidebarComponent_ul_25_Template, 10, 16, "ul", 9);
        ɵɵelementEnd();
        ...
        ɵɵlistener("click", function NavigationSidebarComponent_Template_a_click_30_listener() { return ctx.showAbout = true; });
        ɵɵtext(31, "About");
        ɵɵelementEnd();
        ɵɵelementEnd();
        ɵɵelementEnd();
        ...
        ɵɵlistener("click", function NavigationSidebarComponent_Template_div_click_33_listener() { return ctx.showAbout = false; });
        ɵɵelementEnd();
        ...
        ɵɵtext(37, "Luplink");
        ɵɵelementEnd();
        ɵɵelementStart(38, "small", 17);
        ɵɵtext(39);
        ɵɵelementEnd();
        ɵɵelement(40, "br");
        ɵɵelementStart(41, "a", 18);
        ɵɵtext(42, "License AGPL v3");
        ɵɵelementEnd();
        ɵɵelementStart(43, "article", 19);
        ...
        ɵɵtext(48, "Luplink: ");
        ɵɵelementEnd();
        ɵɵelementStart(49, "a", 22);
        ɵɵtext(50, "See on Gitlab ");
        ɵɵelementEnd();
        ɵɵelement(51, "br");
        ɵɵelementStart(52, "strong");
        ɵɵtext(53, "ngx-luplink: ");
        ɵɵelementEnd();
        ɵɵelementStart(54, "a", 23);
        ɵɵtext(55, "See on npmjs.com");
        ɵɵelementEnd();
        ɵɵelement(56, "br");
        ɵɵelementStart(57, "strong");
        ɵɵtext(58, "python-linkpredict (backend): ");
        ɵɵelementEnd();
        ɵɵelementStart(59, "a", 24);
        ɵɵtext(60, "https://gitlab.com/librecube/lib/python-linkpredict/");
        ɵɵelementEnd();
        ɵɵelement(61, "br");
        ɵɵelement(62, "br");
        ...
        ɵɵtext(64, "Built by:");
        ɵɵelementEnd();
        ɵɵtext(65, " Julien Prissimitzis / ");
        ɵɵelementStart(66, "small");
        ɵɵelementStart(67, "a", 25);
        ɵɵelement(68, "fa-icon", 26);
        ɵɵtext(69, " Contact ");
        ɵɵelementEnd();
        ɵɵelementEnd();
        ɵɵelement(70, "br");
        ɵɵelementStart(71, "strong");
        ɵɵtext(72, "Supervisor:");
        ɵɵelementEnd();
        ɵɵtext(73, " Thibault Gateau");
        ɵɵelement(74, "br");
        ɵɵelementEnd();
        ɵɵelementEnd();
        ɵɵelementStart(75, "div", 27);
        ɵɵelementStart(76, "a", 28);
        ɵɵelement(77, "img", 29);
        ɵɵelementEnd();
        ɵɵelementStart(78, "a", 30);
        ɵɵelement(79, "img", 31);
        ɵɵelementEnd();
        ɵɵelementStart(80, "a", 32);
        ɵɵelement(81, "img", 33);
        ɵɵelementEnd();
        ɵɵelementEnd();
        ɵɵelementEnd();
...
function StepbarComponent_fa_icon_5_Template(rf, ctx) { if (rf & 1) {
    ...
    const ctx_r0 = ɵɵnextContext();
    ɵɵproperty("icon", ctx_r0.faExclamation);
} }
...
function StepbarComponent_fa_icon_13_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵɵproperty("icon", ctx_r2.faExclamation);
} }
function StepbarComponent_fa_icon_14_Template(rf, ctx) { if (rf & 1) {
    ɵɵelement(0, "fa-icon", 9);
} if (rf & 2) {
    const ctx_r3 = ɵɵnextContext();
    ɵɵproperty("icon", ctx_r3.faCheck);
} }
function StepbarComponent_fa_icon_21_Template(rf, ctx) { if (rf & 1) {
    ɵɵelement(0, "fa-icon", 9);
} if (rf & 2) {
    const ctx_r4 = ɵɵnextContext();
    ɵɵproperty("icon", ctx_r4.faExclamation);
} }
function StepbarComponent_fa_icon_22_Template(rf, ctx) { if (rf & 1) {
    ɵɵelement(0, "fa-icon", 9);
} if (rf & 2) {
    const ctx_r5 = ɵɵnextContext();
    ɵɵproperty("icon", ctx_r5.faCheck);
} }
const _c0$3 = function (a0) { return { "is-active": a0 }; };
const _c1$1 = function (a0, a1) { return { "is-warning": a0, "is-success": a1 }; };
// interface Validity {
...
StepbarComponent.ɵcmp = ɵɵdefineComponent({ type: StepbarComponent, selectors: [["lib-stepbar"]], inputs: { validity: "validity", step: "step" }, decls: 31, vars: 30, consts: [[1, "section", "pb-0", "pt-5"], [1, "steps", "is-medium", "is-centered", "has-content-centered"], [1, "steps-segment", 3, "ngClass"], [1, "steps-marker", 3, "ngClass"], [1, "icon"], [3, "icon", 4, "ngIf"], [1, "steps-content"], [1, "heading"], [1, "steps-marker"], [3, "icon"]], template: function StepbarComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        ɵɵelementEnd();
        ɵɵelementEnd();
        ɵɵelementStart(10, "li", 2);
        ɵɵelementStart(11, "span", 3);
        ɵɵelementStart(12, "span", 4);
        ɵɵtemplate(13, StepbarComponent_fa_icon_13_Template, 1, 1, "fa-icon", 5);
        ɵɵtemplate(14, StepbarComponent_fa_icon_14_Template, 1, 1, "fa-icon", 5);
        ɵɵelementEnd();
        ɵɵelementEnd();
        ...
        ɵɵelementEnd();
        ɵɵelementEnd();
        ɵɵelementStart(18, "li", 2);
        ɵɵelementStart(19, "span", 3);
        ɵɵelementStart(20, "span", 4);
        ɵɵtemplate(21, StepbarComponent_fa_icon_21_Template, 1, 1, "fa-icon", 5);
        ɵɵtemplate(22, StepbarComponent_fa_icon_22_Template, 1, 1, "fa-icon", 5);
        ɵɵelementEnd();
        ɵɵelementEnd();
        ɵɵelementStart(23, "div", 6);
        ɵɵelementStart(24, "p", 7);
        ɵɵtext(25, "Downlink");
        ɵɵelementEnd();
        ɵɵelementEnd();
        ɵɵelementEnd();
        ɵɵelementStart(26, "li", 2);
        ɵɵelement(27, "span", 8);
        ɵɵelementStart(28, "div", 6);
        ɵɵelementStart(29, "p", 7);
        ɵɵtext(30, "Result");
        ɵɵelementEnd();
        ɵɵelementEnd();
        ɵɵelementEnd();
        ...
        ɵɵadvance(2);
        ɵɵproperty("ngClass", ɵɵpureFunction1(13, _c0$3, ctx.isActive("geometry")));
        ɵɵadvance(1);
        ɵɵproperty("ngClass", ɵɵpureFunction2(15, _c1$1, ctx.validity.steps.geometry === "invalid", ctx.validity.steps.geometry === "valid"));
        ɵɵadvance(2);
        ɵɵproperty("ngIf", ctx.validity.steps.geometry === "invalid");
        ɵɵadvance(1);
        ɵɵproperty("ngIf", ctx.validity.steps.geometry === "valid");
        ɵɵadvance(4);
        ɵɵproperty("ngClass", ɵɵpureFunction1(18, _c0$3, ctx.isActive("uplink")));
        ɵɵadvance(1);
        ɵɵproperty("ngClass", ɵɵpureFunction2(20, _c1$1, ctx.validity.steps.uplink === "invalid", ctx.validity.steps.uplink === "valid"));
        ɵɵadvance(2);
        ɵɵproperty("ngIf", ctx.validity.steps.uplink === "invalid");
        ɵɵadvance(1);
        ɵɵproperty("ngIf", ctx.validity.steps.uplink === "valid");
        ɵɵadvance(4);
        ɵɵproperty("ngClass", ɵɵpureFunction1(23, _c0$3, ctx.isActive("downlink")));
        ɵɵadvance(1);
        ɵɵproperty("ngClass", ɵɵpureFunction2(25, _c1$1, ctx.validity.steps.downlink === "invalid", ctx.validity.steps.downlink === "valid"));
        ɵɵadvance(2);
        ɵɵproperty("ngIf", ctx.validity.steps.downlink === "invalid");
        ɵɵadvance(1);
        ɵɵproperty("ngIf", ctx.validity.steps.downlink === "valid");
        ɵɵadvance(4);
        ɵɵproperty("ngClass", ɵɵpureFunction1(28, _c0$3, ctx.isActive("result")));
    } }, directives: [NgClass, NgIf, FaIconComponent], styles: [""] });
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵsetClassMetadata(StepbarComponent, [{
        type: Component,
        args: [{
...
function SimpleDocumentationComponent_div_42_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵɵtext(13, "CC BY-SA 3.0");
    ɵɵelementEnd();
    ɵɵtext(14, ", via Wikimedia Commons");
    ɵɵelementEnd();
    ɵɵelementEnd();
} }
function SimpleDocumentationComponent_div_43_Template(rf, ctx) { if (rf & 1) {
    ɵɵelementStart(0, "div");
    ɵɵelementStart(1, "div", 40);
    ɵɵelementStart(2, "div", 41);
    ɵɵelementStart(3, "p");
    ɵɵtext(4, "The transmitter has the following architecture: ");
    ɵɵelementEnd();
    ɵɵnamespaceSVG();
    ɵɵelementStart(5, "svg", 42);
    ɵɵelementStart(6, "defs");
    ɵɵelementStart(7, "marker", 43);
    ɵɵelement(8, "path", 44);
    ɵɵelementEnd();
    ɵɵelementStart(9, "marker", 45);
    ɵɵelement(10, "path", 46);
    ɵɵelementEnd();
    ɵɵelementEnd();
    ɵɵelementStart(11, "g", 47);
    ɵɵelement(12, "path", 48);
    ɵɵelementStart(13, "text", 49);
    ɵɵelementStart(14, "tspan", 50);
    ɵɵtext(15, "Tx");
    ɵɵelementEnd();
    ɵɵelementEnd();
    ...
    ɵɵelementEnd();
    ɵɵelementStart(18, "g", 53);
    ɵɵelement(19, "path", 54);
    ɵɵelement(20, "path", 55);
    ɵɵelement(21, "path", 56);
    ɵɵelementEnd();
    ɵɵelement(22, "rect", 57);
    ɵɵelement(23, "rect", 58);
    ɵɵelementStart(24, "text", 59);
    ɵɵelementStart(25, "tspan", 60);
    ɵɵelementStart(26, "tspan", 60);
    ɵɵtext(27, "Filter");
    ɵɵelementEnd();
    ɵɵelementEnd();
    ɵɵelementEnd();
    ɵɵelementStart(28, "g", 61);
    ɵɵelement(29, "path", 62);
    ɵɵelement(30, "path", 63);
    ɵɵelement(31, "path", 64);
    ɵɵelement(32, "path", 65);
    ɵɵelement(33, "path", 66);
    ɵɵelement(34, "path", 67);
    ɵɵelement(35, "path", 68);
    ɵɵelement(36, "path", 69);
    ɵɵelement(37, "path", 70);
    ɵɵelement(38, "path", 71);
    ɵɵelement(39, "path", 72);
    ɵɵelement(40, "path", 73);
    ɵɵelement(41, "path", 74);
    ɵɵelement(42, "path", 75);
    ɵɵelement(43, "path", 76);
    ɵɵelement(44, "path", 77);
    ɵɵelement(45, "path", 78);
    ɵɵelement(46, "path", 79);
    ɵɵelement(47, "path", 80);
    ɵɵelementEnd();
    ɵɵelement(48, "path", 81);
    ɵɵelementStart(49, "text", 82);
    ɵɵelementStart(50, "tspan", 83);
    ɵɵtext(51, "Antenna Mismatch");
    ɵɵelementEnd();
    ɵɵelementEnd();
    ɵɵelementEnd();
    ɵɵelementEnd();
    ...
    ɵɵelement(52, "br");
    ɵɵelementStart(53, "p");
    ɵɵtext(54, "We need to calculate the total line losses to determine the power actually delivered to the antenna. These line losses depend on the line length and quality. We usually try to make these as short as possible on the space segment since we have tight power requirements.");
    ɵɵelementEnd();
    ɵɵelementStart(55, "p");
    ɵɵelementStart(56, "b");
    ɵɵtext(57, "Power in:");
    ...
    ɵɵelementStart(61, "div", 40);
    ɵɵelementStart(62, "div", 41);
    ɵɵelementStart(63, "pre");
    ɵɵtext(64);
    ɵɵpipe(65, "json");
    ɵɵelementEnd();
    ɵɵelementEnd();
    ...
    const ctx_r1 = ɵɵnextContext();
    ɵɵadvance(58);
    ɵɵtextInterpolate2(" ", ctx_r1.form == null ? null : ctx_r1.form.uplink == null ? null : ctx_r1.form.uplink.transmitter.power.value, " ", ctx_r1.form == null ? null : ctx_r1.form.uplink == null ? null : ctx_r1.form.uplink.transmitter.power.unit, "");
    ɵɵadvance(6);
    ɵɵtextInterpolate1("            ", ɵɵpipeBind1(65, 4, ctx_r1.form == null ? null : ctx_r1.form.uplink == null ? null : ctx_r1.form.uplink.transmitter), "\n          ");
    ɵɵadvance(4);
    ɵɵtextInterpolate1("            ", ɵɵpipeBind1(69, 6, ctx_r1.formService.getFormData().uplink.transmitter), "\n          ");
} }
function SimpleDocumentationComponent_div_44_Template(rf, ctx) { if (rf & 1) {
    ɵɵelementStart(0, "div");
    ɵɵelementStart(1, "div", 40);
    ɵɵelementStart(2, "div", 41);
    ɵɵnamespaceSVG();
    ɵɵelementStart(3, "svg", 84);
    ɵɵelementStart(4, "g", 85);
    ɵɵelementStart(5, "text", 49);
    ɵɵelementStart(6, "tspan", 50);
    ɵɵtext(7, "Tx");
    ɵɵelementEnd();
    ɵɵelementEnd();
    ɵɵelementStart(8, "g", 86);
    ɵɵelement(9, "path", 87);
    ɵɵelement(10, "path", 88);
    ɵɵelement(11, "path", 89);
    ɵɵelementEnd();
    ɵɵelement(12, "path", 90);
    ɵɵelement(13, "rect", 57);
    ɵɵelement(14, "rect", 58);
    ɵɵelementStart(15, "text", 59);
    ɵɵelementStart(16, "tspan", 60);
    ɵɵelementStart(17, "tspan", 60);
    ɵɵtext(18, "Filter");
    ɵɵelementEnd();
    ɵɵelementEnd();
    ɵɵelementEnd();
    ɵɵelementStart(19, "g", 61);
    ...
    ɵɵelement(26, "path", 93);
    ɵɵelement(27, "path", 69);
    ɵɵelement(28, "path", 70);
    ɵɵelement(29, "path", 71);
    ɵɵelement(30, "path", 94);
    ɵɵelement(31, "path", 73);
    ɵɵelement(32, "path", 95);
    ɵɵelement(33, "path", 75);
    ɵɵelement(34, "path", 76);
    ɵɵelement(35, "path", 77);
    ɵɵelement(36, "path", 96);
    ɵɵelement(37, "path", 79);
    ɵɵelement(38, "path", 97);
    ɵɵelementEnd();
    ɵɵelementStart(39, "text", 82);
    ɵɵelement(40, "tspan", 83);
    ɵɵelementEnd();
    ɵɵelementStart(41, "g", 98);
    ɵɵelementStart(42, "g", 99);
    ɵɵelement(43, "path", 100);
    ɵɵelementEnd();
    ɵɵelementStart(44, "text", 101);
    ɵɵelementStart(45, "tspan", 102);
    ɵɵtext(46, "Rx");
    ɵɵelementEnd();
    ɵɵelementEnd();
    ɵɵelementEnd();
    ...
    ɵɵtext(49, "Temperatures:");
    ɵɵelementEnd();
    ɵɵtext(50, " We define a system temperature that is used to determine the noise in the link. The system temperature is defined as: ");
    ɵɵelement(51, "ng-katex-html", 32);
    ɵɵtext(52, " This is the ");
    ɵɵelementStart(53, "a", 103);
    ɵɵtext(54, "Friis formula for noise temperature");
    ɵɵelementEnd();
    ɵɵtext(55, ". We use this temperature in order to compute G/T out of the antena.");
    ɵɵelement(56, "br");
    ɵɵtext(57, " Here we consider the system to only have a LNA. ");
    ɵɵelementEnd();
    ɵɵelementEnd();
    ɵɵelementEnd();
} if (rf & 2) {
    const ctx_r2 = ɵɵnextContext();
    ɵɵadvance(51);
    ɵɵproperty("html", ctx_r2.systemTemperature);
} }
const _c0$4 = function (a0) { return { "is-hidden": a0 }; };
class SimpleDocumentationComponent {
    // cf: https://github.com/garciparedes/ng-katex
    constructor(formService, logger, changeDetector) {
        this.formService = formService;
        this.logger = logger;
  ...
  `;
    ...
    drawGeometry() {
        ...
        this.formService.getFormData$().subscribe((obs) => {
    ...
    updateDiagram(geo, precision = 3) {
        const alt = parseFloat(geo.altitude.value);
        const sr = parseFloat(geo.slantRange.value);
...
SimpleDocumentationComponent.ɵcmp = ɵɵdefineComponent({ type: SimpleDocumentationComponent, selectors: [["lib-simple-documentation"]], inputs: { component: "component" }, decls: 45, vars: 7, consts: [[3, "ngClass"], ["id", "sr", 2, "text-align", "center"], ["width", "100mm", "height", "100mm", "version", "1.1", "viewBox", "0 0 100 100", "xmlns", "http://www.w3.org/2000/svg"], ["id", "DotM", "orient", "auto", 2, "overflow", "visible"], ["transform", "matrix(.4 0 0 .4 2.96 .4)", "d", "m-2.5-1c0 2.76-2.24 5-5 5s-5-2.24-5-5 2.24-5 5-5 5 2.24 5 5z", 2, "fill-rule", "evenodd", "fill", "#273445", "stroke-width", "1pt", "stroke", "#273445"], ["transform", "translate(-1.9512 12.867)"], ["d", "m63.25 47.74s3.2279-1.8388 0.39365-4.7054", 2, "fill", "none", "stroke-width", ".1299px", "stroke", "#000"], ["d", "m18.195 47.825 72.711-7.6302", 2, "fill", "#273445", "stroke-dasharray", "0.78553516, 0.78553516", "stroke-width", ".19638", "stroke", "#ed5353"], ["d", "m18.901 43.953 43.02-37.414", 2, "fill", "#273445", "stroke-dasharray", "0.78553515, 0.78553515", "stroke-width", ".19638", "stroke", "#000"], ["d", "m18.195 47.825 75.898-0.29524", 2, "fill", "#273445", "stroke-width", ".39277", "stroke", "#667885"], ["d", "m20.092 47.657 0.03936-53.571", 2, "fill", "none", "stroke-width", ".1299px", "stroke", "#7e8087"], ["transform", "matrix(.11271 0 0 .11271 20.484 37.582)"], ["transform", "translate(-93.027 -20.17)"], ["d", "m89.549 109.56h-32.099l16.05-55.728z", 2, "fill", "#fafafa", "stroke-linecap", "square", "stroke-linejoin", "round", "stroke-width", "2.011", "stroke", "#0e141f"], ["d", "m65.318 41.111a34.249 36.58 8.5053 0 0-3.7514 16.562 34.249 36.58 8.5053 0 0 34.268 35.857 34.249 36.58 8.5053 0 0 15.515-4.2531z", 2, "fill", "#fafafa", "stroke-linecap", "square", "stroke-linejoin", "round", "stroke-width", "1.9022", "stroke", "#0e141f"], ["d", "m12.408 98.696a25.719 25.719 0 0 0 6.2197 0.79589 25.719 25.719 0 0 0 25.719-25.719 25.719 25.719 0 0 0-3.5591-12.993 38.906 38.906 0 0 1 0.01625 0.46149 38.906 38.906 0 0 1-0.19434 3.8841 38.906 38.906 0 0 1-0.58125 3.8455 38.906 38.906 0 0 1-0.96207 3.7681 38.906 38.906 0 0 1-1.3335 3.6532 38.906 38.906 0 0 1-1.6917 3.502 38.906 38.906 0 0 1-2.0327 3.3155 38.906 38.906 0 0 1-2.3534 3.0958 38.906 38.906 0 0 1-2.651 2.8456 38.906 38.906 0 0 1-2.9217 2.5668 38.906 38.906 0 0 1-3.1633 2.2621 38.906 38.906 0 0 1-3.3736 1.935 38.906 38.906 0 0 1-3.5497 1.5887 38.906 38.906 0 0 1-3.5872 1.1919z", 2, "fill", "#002e99", "stroke-linecap", "square", "stroke-linejoin", "round", "stroke-width", ".98732", "stroke", "#002e99"], ["d", "m12.408 98.696a38.906 38.906 0 0 0 3.5872-1.1919 38.906 38.906 0 0 0 3.5497-1.5887 38.906 38.906 0 0 0 3.3736-1.935 38.906 38.906 0 0 0 3.1633-2.2621 38.906 38.906 0 0 0 2.9217-2.5668 38.906 38.906 0 0 0 2.651-2.8456 38.906 38.906 0 0 0 2.3534-3.0958 38.906 38.906 0 0 0 2.0327-3.3155 38.906 38.906 0 0 0 1.6917-3.502 38.906 38.906 0 0 0 1.3335-3.6532 38.906 38.906 0 0 0 0.96207-3.7681 38.906 38.906 0 0 0 0.58125-3.8455 38.906 38.906 0 0 0 0.19435-3.8841 38.906 38.906 0 0 0-0.01626-0.46149 25.719 25.719 0 0 0-22.16-12.726 25.719 25.719 0 0 0-25.719 25.719 25.719 25.719 0 0 0 19.499 24.923z", 2, "fill", "#0d52bf", "stroke-linecap", "square", "stroke-linejoin", "round", "stroke-width", ".98732", "stroke", "#002e99"], ["cx", "18.103", "cy", "74.979", "r", "80.736", 2, "fill", "none", "stroke-linecap", "square", "stroke-linejoin", "round", "stroke-width", ".73644", "stroke", "#8cd5ff"], ["x", "70.818298", "y", "50.84721", 0, "xml", "space", "preserve", 2, "fill", "#000000", "font-family", "sans-serif", "font-size", "2.7461px", "letter-spacing", "0px", "line-height", "1.25", "stroke-width", ".20596", "word-spacing", "0px"], ["x", "70.818298", "y", "50.84721", 2, "stroke-width", ".20596"], ["transform", "rotate(-40.986)", "x", "5.6012249", "y", "44.476562", 0, "xml", "space", "preserve", 2, "fill", "#000000", "font-family", "sans-serif", "font-size", "2.7461px", "letter-spacing", "0px", "line-height", "1.25", "stroke-width", ".20596", "word-spacing", "0px"], ["x", "5.6012249", "y", "44.476562", 2, "stroke-width", ".20596"], ["transform", "rotate(.074247)", "x", "5.4076142", "y", "3.2867277", 0, "xml", "space", "preserve", 2, "fill", "#000000", "font-family", "sans-serif", "font-size", "2.7461px", "letter-spacing", "0px", "line-height", "1.25", "stroke-width", ".20596", "word-spacing", "0px"], ["x", "5.4076142", "y", "3.2867277", 2, "stroke-width", ".20596"], ["transform", "rotate(-6.1089)", "x", "44.048023", "y", "48.248531", 0, "xml", "space", "preserve", 2, "fill", "#000000", "font-family", "sans-serif", "font-size", "2.7461px", "letter-spacing", "0px", "line-height", "1.25", "stroke-width", ".20596", "word-spacing", "0px"], ["x", "44.048023", "y", "48.248531", 2, "stroke-width", ".20596"], ["transform", "matrix(.15459 .16472 -.16472 .15459 74.703 -33.297)"], ["d", "m88.807 180.05c-3.9758 3e-3 -7.2787 2.8874-7.5811 6.6193 4.9024-2.7815 9.9481-2.9285 15.168 0-0.30262-3.7338-3.6088-6.6184-7.5867-6.6193z", 2, "fill", "#273445", "stroke-linecap", "square", "stroke-width", "1.0466", "stroke", "#273445"], ["x", "42.505", "y", "159.4", "width", "96.573", "height", "11.906", 2, "fill", "#002e99", "stroke-linecap", "square", "stroke-linejoin", "round", "stroke-width", "1.5", "stroke", "#0d52bf"], ["x", "75.578", "y", "151.46", "width", "27.905", "height", "27.781", 2, "fill", "#ffe16b", "stroke-linecap", "square", "stroke-linejoin", "round", "stroke-width", "1.2367", "stroke", "#f9c440"], ["d", "m88.807 184.53v2.6866", 2, "fill", "#273445", "marker-end", "url(#DotM)", "stroke-width", ".27078", "stroke", "#273445"], [2, "padding", "10px", "margin", "auto", "margin-top", "15px", "max-width", "90%"], [3, "html"], [4, "ngIf"], [1, "title"], ["src", "/assets/diagrams/fspl.svg"], ["src", "/assets/diagrams/ber.png"], [2, "float", "right", "color", "grey"], ["href", "https://commons.wikimedia.org/wiki/File:PSK_BER_curves.svg"], ["href", "http://creativecommons.org/licenses/by-sa/3.0/"], [1, "columns", "is-multiline"], [1, "column"], ["id", "transmitter", "width", " 90mm", "height", "25mm", "version", "1.1", "viewBox", "0 0 340.16 94.488", "xmlns", "http://www.w3.org/2000/svg"], ["id", "Arrow2Send", "orient", "auto", 2, "overflow", "visible"], ["transform", "matrix(-.3 0 0 -.3 .69 0)", "d", "m8.7186 4.0337-10.926-4.0177 10.926-4.0177c-1.7455 2.3721-1.7354 5.6175-6e-7 8.0354z", 2, "fill-rule", "evenodd", "fill", "#c83737", "stroke-linejoin", "round", "stroke-width", ".625", "stroke", "#c83737"], ["id", "a", "orient", "auto", 2, "overflow", "visible"], ["transform", "matrix(.3 0 0 .3 -.69 0)", "d", "m8.7186 4.0337-10.926-4.0177 10.926-4.0177c-1.7455 2.3721-1.7354 5.6175-6e-7 8.0354z", 2, "fill-rule", "evenodd", "fill", "#c83737", "stroke-linejoin", "round", "stroke-width", ".625", "stroke", "#c83737"], ["transform", "matrix(1 0 0 1.0279 -24.971 -102.43)"], ["d", "m79.364 162.81-53.49 27.974v-55.947l26.746 13.987z", 2, "fill", "#19aeff", "stroke-linejoin", "round", "stroke-width", "1.7103", "stroke", "#005c94"], ["transform", "scale(.95917 1.0426)", "x", "33.86866", "y", "163.47594", 0, "xml", "space", "preserve", 2, "fill", "#ffffff", "font-family", "sans-serif", "font-size", "41.667px", "letter-spacing", "0px", "line-height", "1.25", "stroke-width", "1.0416", "word-spacing", "0px"], ["x", "33.86866", "y", "163.47594", 2, "fill", "#ffffff", "font-size", "19.444px", "stroke-width", "1.0416"], ["id", "line-tx", "transform", "matrix(16.008 0 0 3.61 -479.73 -275.49)", 2, "paint-order", "stroke fill markers"], ["d", "m34.925 121.41 11.897 0.0139", 2, "fill", "#009100", "stroke-width", ".64874", "stroke", "#009100"], ["id", "antenna-tx", "transform", "matrix(4.0672 0 0 4.4208 49.207 -284.58)", 2, "fill", "none", "stroke-linecap", "round", "stroke-linejoin", "round", "stroke-width", ".4", "stroke", "#009100"], ["d", "m54.24 101.21v-13.122", 2, "fill", "none", "stroke-linecap", "round", "stroke-linejoin", "miter", "stroke-width", ".40003", "stroke", "#009100"], ["d", "m50.271 88.088 3.9688 6.8792", 2, "fill", "none", "stroke-linecap", "round", "stroke-linejoin", "round", "stroke-width", ".4", "stroke", "#009100"], ["d", "m58.208 88.088-3.9688 6.8792", 2, "fill", "none", "stroke-linecap", "round", "stroke-linejoin", "round", "stroke-width", ".4", "stroke", "#009100"], ["x", "103.26", "y", "145.82", "width", "48.507", "height", "33.346", 2, "fill", "#006680", "stroke-linecap", "square", "stroke-width", "1.2577", "stroke", "#364e59"], ["x", "188.01", "y", "145.82", "width", "48.507", "height", "33.346", 2, "fill", "#006680", "stroke-linecap", "square", "stroke-width", "1.2577", "stroke", "#364e59"], ["transform", "scale(1.0158 .98444)", "x", "110.38757", "y", "169.47885", 0, "xml", "space", "preserve", 2, "fill", "#ffffff", "font-family", "sans-serif", "font-size", "12.586px", "letter-spacing", "0px", "line-height", "1.25", "stroke-width", ".94394", "word-spacing", "0px"], ["x", "110.38757", "y", "169.47885", 2, "stroke-width", ".94394"], ["transform", "matrix(.95886 0 0 .92925 107.65 95.665)", "aria-label", "Other in-line devices", 2, "fill", "#fff"], ["d", "m92.632 65.239q0 0.86328-0.33203 1.5117-0.32812 0.64844-0.94531 0.99609-0.61719 0.34766-1.457 0.34766-0.84766 0-1.4648-0.34375-0.61328-0.34375-0.9375-0.99219-0.32422-0.65234-0.32422-1.5195 0-1.3203 0.72266-2.0625 0.72266-0.74609 2.0117-0.74609 0.83984 0 1.457 0.33594 0.61719 0.33203 0.94141 0.96875 0.32812 0.63672 0.32812 1.5039zm-0.76172 0q0-1.0273-0.51562-1.6133-0.51172-0.58594-1.4492-0.58594-0.94531 0-1.4609 0.57812t-0.51562 1.6211q0 1.0352 0.51953 1.6445 0.52344 0.60547 1.4492 0.60547 0.95312 0 1.4609-0.58594 0.51172-0.58984 0.51172-1.6641z"], ["d", "m95.175 67.985q-0.34766 0.09375-0.71094 0.09375-0.84375 0-0.84375-0.95703v-2.8203h-0.48828v-0.51172h0.51562l0.20703-0.94531h0.46875v0.94531h0.78125v0.51172h-0.78125v2.668q0 0.30469 0.09766 0.42969 0.10156 0.12109 0.34766 0.12109 0.14062 0 0.40625-0.05469z"], ["d", "m96.468 64.512q0.22656-0.41406 0.54297-0.60547 0.32031-0.19531 0.80859-0.19531 0.6875 0 1.0117 0.34375 0.32812 0.33984 0.32812 1.1445v2.8164h-0.70703v-2.6797q0-0.44531-0.08203-0.66016-0.08203-0.21875-0.26953-0.32031-0.1875-0.10156-0.51953-0.10156-0.49609 0-0.79688 0.34375-0.29688 0.34375-0.29688 0.92578v2.4922h-0.70313v-5.7969h0.70312v1.5078q0 0.23828-0.01563 0.49219-0.01172 0.25391-0.01563 0.29297z"], ["d", "m100.76 66.051q0 0.72656 0.30078 1.1211t0.87891 0.39453q0.45703 0 0.73047-0.18359 0.27734-0.18359 0.375-0.46484l0.61719 0.17578q-0.37891 1-1.7227 1-0.9375 0-1.4297-0.55859-0.48828-0.55859-0.48828-1.6602 0-1.0469 0.48828-1.6055 0.49219-0.55859 1.4024-0.55859 1.8633 0 1.8633 2.2461v0.09375zm2.2891-0.53906q-0.0586-0.66797-0.33984-0.97266-0.28125-0.30859-0.80859-0.30859-0.51172 0-0.8125 0.34375-0.29688 0.33984-0.32032 0.9375z"], ["d", "m104.69 68.016v-3.2422q0-0.44531-0.0234-0.98438h0.66406q0.0312 0.71875 0.0312 0.86328h0.0156q0.16797-0.54297 0.38672-0.74219 0.21875-0.19922 0.61719-0.19922 0.14062 0 0.28515 0.03906v0.64453q-0.14062-0.03906-0.375-0.03906-0.4375 0-0.66797 0.37891-0.23047 0.375-0.23047 1.0781v2.2031z"], ["d", "m109.56 62.891v-0.67188h0.70313v0.67188zm0 5.125v-4.2266h0.70313v4.2266z"], ["d", "m114.03 68.016v-2.6797q0-0.41797-0.082-0.64844t-0.26172-0.33203q-0.17968-0.10156-0.52734-0.10156-0.50781 0-0.80078 0.34766-0.29297 0.34766-0.29297 0.96484v2.4492h-0.70313v-3.3242q0-0.73828-0.0234-0.90234h0.66406q4e-3 0.01953 8e-3 0.10547 4e-3 0.08594 8e-3 0.19922 8e-3 0.10938 0.0156 0.41797h0.0117q0.24219-0.4375 0.55859-0.61719 0.32031-0.18359 0.79297-0.18359 0.69531 0 1.0156 0.34766 0.32421 0.34375 0.32421 1.1406v2.8164z"], ["d", "m115.62 66.203v-0.625h1.9531v0.625z"], ["d", "m118.47 68.016v-5.7969h0.70312v5.7969z"], ["d", "m120.25 62.891v-0.67188h0.70313v0.67188zm0 5.125v-4.2266h0.70313v4.2266z"], ["d", "m124.72 68.016v-2.6797q0-0.41797-0.082-0.64844t-0.26172-0.33203q-0.17968-0.10156-0.52734-0.10156-0.50781 0-0.80078 0.34766-0.29297 0.34766-0.29297 0.96484v2.4492h-0.70313v-3.3242q0-0.73828-0.0234-0.90234h0.66406q4e-3 0.01953 8e-3 0.10547 4e-3 0.08594 8e-3 0.19922 8e-3 0.10938 0.0156 0.41797h0.0117q0.24219-0.4375 0.55859-0.61719 0.32031-0.18359 0.79297-0.18359 0.69531 0 1.0156 0.34766 0.32421 0.34375 0.32421 1.1406v2.8164z"], ["d", "m127.03 66.051q0 0.72656 0.30078 1.1211t0.8789 0.39453q0.45704 0 0.73047-0.18359 0.27735-0.18359 0.375-0.46484l0.61719 0.17578q-0.37891 1-1.7227 1-0.9375 0-1.4297-0.55859-0.48828-0.55859-0.48828-1.6602 0-1.0469 0.48828-1.6055 0.49218-0.55859 1.4023-0.55859 1.8633 0 1.8633 2.2461v0.09375zm2.2891-0.53906q-0.0586-0.66797-0.33984-0.97266-0.28125-0.30859-0.8086-0.30859-0.51172 0-0.8125 0.34375-0.29687 0.33984-0.32031 0.9375z"], ["d", "m98.233 84.003q-0.19531 0.40625-0.51953 0.58203-0.32031 0.17578-0.79688 0.17578-0.80078 0-1.1797-0.53906-0.375-0.53906-0.375-1.6328 0-2.2109 1.5547-2.2109 0.48047 0 0.80078 0.17578 0.32031 0.17578 0.51562 0.55859h0.0078l-0.0078-0.47266v-1.7539h0.70312v4.9258q0 0.66016 0.02344 0.87109h-0.67188q-0.01172-0.0625-0.02734-0.28906-0.01172-0.22656-0.01172-0.39062zm-2.1328-1.4375q0 0.88672 0.23438 1.2695 0.23438 0.38281 0.76172 0.38281 0.59766 0 0.86719-0.41406 0.26953-0.41406 0.26953-1.2852 0-0.83984-0.26953-1.2305t-0.85938-0.39062q-0.53125 0-0.76953 0.39453-0.23438 0.39062-0.23438 1.2734z"], ["d", "m100.56 82.718q0 0.72656 0.30078 1.1211t0.8789 0.39453q0.45704 0 0.73047-0.18359 0.27735-0.18359 0.375-0.46484l0.61719 0.17578q-0.37891 1-1.7227 1-0.9375 0-1.4297-0.55859-0.48828-0.55859-0.48828-1.6602 0-1.0469 0.48828-1.6055 0.49218-0.55859 1.4023-0.55859 1.8633 0 1.8633 2.2461v0.09375zm2.2891-0.53906q-0.0586-0.66797-0.33984-0.97266-0.28125-0.30859-0.8086-0.30859-0.51172 0-0.8125 0.34375-0.29687 0.33984-0.32031 0.9375z"], ["d", "m106.33 84.683h-0.83203l-1.5352-4.2266h0.75l0.92969 2.75q0.0508 0.15625 0.26953 0.92578l0.13672-0.45703 0.15234-0.46094 0.96094-2.7578h0.74609z"], ["d", "m108.47 79.558v-0.67188h0.70313v0.67188zm0 5.125v-4.2266h0.70313v4.2266z"], ["d", "m110.79 82.55q0 0.84375 0.26562 1.25 0.26563 0.40625 0.80078 0.40625 0.375 0 0.625-0.20312 0.25391-0.20312 0.3125-0.625l0.71094 0.04687q-0.082 0.60938-0.51953 0.97266-0.4375 0.36328-1.1094 0.36328-0.88672 0-1.3555-0.55859-0.46484-0.5625-0.46484-1.6367 0-1.0664 0.46875-1.625 0.46875-0.5625 1.3438-0.5625 0.64844 0 1.0742 0.33594 0.42969 0.33594 0.53906 0.92578l-0.72265 0.05469q-0.0547-0.35156-0.27735-0.55859t-0.63281-0.20703q-0.55859 0-0.80859 0.37109-0.25 0.37109-0.25 1.25z"], ["d", "m114.79 82.718q0 0.72656 0.30078 1.1211t0.87891 0.39453q0.45703 0 0.73047-0.18359 0.27734-0.18359 0.375-0.46484l0.61719 0.17578q-0.37891 1-1.7227 1-0.9375 0-1.4297-0.55859-0.48828-0.55859-0.48828-1.6602 0-1.0469 0.48828-1.6055 0.49219-0.55859 1.4024-0.55859 1.8633 0 1.8633 2.2461v0.09375zm2.2891-0.53906q-0.0586-0.66797-0.33984-0.97266-0.28125-0.30859-0.80859-0.30859-0.51172 0-0.8125 0.34375-0.29688 0.33984-0.32032 0.9375z"], ["d", "m121.88 83.515q0 0.59766-0.45313 0.92188-0.44921 0.32422-1.2617 0.32422-0.78907 0-1.2188-0.25781-0.42579-0.26172-0.55469-0.8125l0.62109-0.12109q0.0898 0.33984 0.3711 0.5 0.28125 0.15625 0.78125 0.15625 0.53515 0 0.78125-0.16406 0.25-0.16406 0.25-0.49219 0-0.25-0.17188-0.40625-0.17187-0.15625-0.55469-0.25781l-0.5039-0.13281q-0.60547-0.15625-0.86328-0.30469-0.25391-0.15234-0.39844-0.36719t-0.14453-0.52734q0-0.57812 0.41015-0.87891 0.41407-0.30469 1.2031-0.30469 0.69922 0 1.1094 0.24609 0.41407 0.24609 0.52344 0.78906l-0.63281 0.07813q-0.0586-0.28125-0.31641-0.42969-0.2539-0.15234-0.68359-0.15234-0.47656 0-0.70313 0.14453-0.22656 0.14453-0.22656 0.4375 0 0.17969 0.0937 0.29688 0.0937 0.11719 0.27734 0.19922 0.1836 0.08203 0.77344 0.22656 0.5586 0.14062 0.80469 0.26172 0.24609 0.11719 0.38672 0.26172 0.14453 0.14453 0.22265 0.33594 0.0781 0.1875 0.0781 0.42969z"], ["d", "m275.16 144.7v16.133", 2, "fill", "#c83737", "marker-end", "url(#Arrow2Send)", "marker-start", "url(#a)", "stroke-width", "1.8879", "stroke", "#c83737"], ["transform", "scale(1.0158 .98444)", "x", "275.77902", "y", "157.34232", 0, "xml", "space", "preserve", 2, "fill", "#000000", "font-family", "sans-serif", "font-size", "12.586px", "letter-spacing", "0px", "line-height", "1.25", "stroke-width", ".94394", "word-spacing", "0px"], ["x", "275.77902", "y", "157.34232", 2, "font-size", "10.069px", "stroke-width", ".94394"], ["id", "rx", "width", "80mm", "height", "25mm", "version", "1.1", "viewBox", "0 0 302.36 94.488", "xmlns", "http://www.w3.org/2000/svg"], ["transform", "matrix(1,0,0,1.0279,-24.971,-102.43)"], ["id", "antenna-tx", "transform", "matrix(4.0672 0 0 4.4208 -160.92 -286.13)", 2, "fill", "none", "stroke-linecap", "round", "stroke-linejoin", "round", "stroke-width", ".4", "stroke", "#f60"], ["d", "m54.24 101.21v-13.122", 2, "fill", "none", "stroke-linecap", "round", "stroke-linejoin", "miter", "stroke-width", ".40003", "stroke", "#f60"], ["d", "m50.271 88.088 3.9688 6.8792", 2, "fill", "none", "stroke-linecap", "round", "stroke-linejoin", "round", "stroke-width", ".4", "stroke", "#f60"], ["d", "m58.208 88.088-3.9688 6.8792", 2, "fill", "none", "stroke-linecap", "round", "stroke-linejoin", "round", "stroke-width", ".4", "stroke", "#f60"], ["d", "m270.69 161.35-211.01-0.0491", 2, "fill", "none", "stroke-width", "2.17", "stroke", "#f60"], ["d", "m96.468 64.512q0.22656-0.41406 0.54297-0.60547 0.32031-0.19531 0.80859-0.19531 0.6875 0 1.0117 0.34375 0.32812 0.33984 0.32812 1.1445v2.8164h-0.70703v-2.6797q0-0.44531-0.08203-0.66016-0.08203-0.21875-0.26953-0.32031t-0.51953-0.10156q-0.49609 0-0.79688 0.34375-0.29688 0.34375-0.29688 0.92578v2.4922h-0.70313v-5.7969h0.70312v1.5078q0 0.23828-0.01563 0.49219-0.01172 0.25391-0.01563 0.29297z"], ["d", "m104.69 68.016v-3.2422q0-0.44531-0.0234-0.98438h0.66406q0.0312 0.71875 0.0312 0.86328h0.0156q0.16797-0.54297 0.38672-0.74219t0.61719-0.19922q0.14062 0 0.28515 0.03906v0.64453q-0.14062-0.03906-0.375-0.03906-0.4375 0-0.66797 0.37891-0.23047 0.375-0.23047 1.0781v2.2031z"], ["d", "m114.03 68.016v-2.6797q0-0.41797-0.082-0.64844t-0.26172-0.33203q-0.17968-0.10156-0.52734-0.10156-0.50781 0-0.80078 0.34766t-0.29297 0.96484v2.4492h-0.70313v-3.3242q0-0.73828-0.0234-0.90234h0.66406q4e-3 0.01953 8e-3 0.10547t8e-3 0.19922q8e-3 0.10938 0.0156 0.41797h0.0117q0.24219-0.4375 0.55859-0.61719 0.32031-0.18359 0.79297-0.18359 0.69531 0 1.0156 0.34766 0.32421 0.34375 0.32421 1.1406v2.8164z"], ["d", "m124.72 68.016v-2.6797q0-0.41797-0.082-0.64844t-0.26172-0.33203q-0.17968-0.10156-0.52734-0.10156-0.50781 0-0.80078 0.34766t-0.29297 0.96484v2.4492h-0.70313v-3.3242q0-0.73828-0.0234-0.90234h0.66406q4e-3 0.01953 8e-3 0.10547t8e-3 0.19922q8e-3 0.10938 0.0156 0.41797h0.0117q0.24219-0.4375 0.55859-0.61719 0.32031-0.18359 0.79297-0.18359 0.69531 0 1.0156 0.34766 0.32421 0.34375 0.32421 1.1406v2.8164z"], ["d", "m98.233 84.003q-0.19531 0.40625-0.51953 0.58203-0.32031 0.17578-0.79688 0.17578-0.80078 0-1.1797-0.53906-0.375-0.53906-0.375-1.6328 0-2.2109 1.5547-2.2109 0.48047 0 0.80078 0.17578t0.51562 0.55859h0.0078l-0.0078-0.47266v-1.7539h0.70312v4.9258q0 0.66016 0.02344 0.87109h-0.67188q-0.01172-0.0625-0.02734-0.28906-0.01172-0.22656-0.01172-0.39062zm-2.1328-1.4375q0 0.88672 0.23438 1.2695 0.23438 0.38281 0.76172 0.38281 0.59766 0 0.86719-0.41406t0.26953-1.2852q0-0.83984-0.26953-1.2305t-0.85938-0.39062q-0.53125 0-0.76953 0.39453-0.23438 0.39062-0.23438 1.2734z"], ["d", "m110.79 82.55q0 0.84375 0.26562 1.25 0.26563 0.40625 0.80078 0.40625 0.375 0 0.625-0.20312 0.25391-0.20312 0.3125-0.625l0.71094 0.04687q-0.082 0.60938-0.51953 0.97266-0.4375 0.36328-1.1094 0.36328-0.88672 0-1.3555-0.55859-0.46484-0.5625-0.46484-1.6367 0-1.0664 0.46875-1.625 0.46875-0.5625 1.3438-0.5625 0.64844 0 1.0742 0.33594 0.42969 0.33594 0.53906 0.92578l-0.72265 0.05469q-0.0547-0.35156-0.27735-0.55859t-0.63281-0.20703q-0.55859 0-0.80859 0.37109t-0.25 1.25z"], ["d", "m121.88 83.515q0 0.59766-0.45313 0.92188-0.44921 0.32422-1.2617 0.32422-0.78907 0-1.2188-0.25781-0.42579-0.26172-0.55469-0.8125l0.62109-0.12109q0.0898 0.33984 0.3711 0.5 0.28125 0.15625 0.78125 0.15625 0.53515 0 0.78125-0.16406 0.25-0.16406 0.25-0.49219 0-0.25-0.17188-0.40625-0.17187-0.15625-0.55469-0.25781l-0.5039-0.13281q-0.60547-0.15625-0.86328-0.30469-0.25391-0.15234-0.39844-0.36719t-0.14453-0.52734q0-0.57812 0.41015-0.87891 0.41407-0.30469 1.2031-0.30469 0.69922 0 1.1094 0.24609 0.41407 0.24609 0.52344 0.78906l-0.63281 0.07813q-0.0586-0.28125-0.31641-0.42969-0.2539-0.15234-0.68359-0.15234-0.47656 0-0.70313 0.14453-0.22656 0.14453-0.22656 0.4375 0 0.17969 0.0937 0.29688t0.27734 0.19922q0.1836 0.08203 0.77344 0.22656 0.5586 0.14062 0.80469 0.26172 0.24609 0.11719 0.38672 0.26172 0.14453 0.14453 0.22265 0.33594 0.0781 0.1875 0.0781 0.42969z"], ["id", "rx", "transform", "matrix(3.7796 0 0 3.7796 -138.23 -292.41)"], ["transform", "matrix(-1.236,0,0,1.3487,147.46,-17.998)", 2, "fill", "#ff4141", "stroke", "#b50000"], ["d", "m31.768 102.36-11.941 5.7454v-11.491l5.9708 2.8727z", 2, "fill", "#ff4141", "stroke-linejoin", "round", "stroke-width", ".36623", "stroke", "#b50000"], ["x", "115.42167", "y", "121.30454", 0, "xml", "space", "preserve", 2, "fill", "#ffffff", "font-family", "sans-serif", "font-size", "8.922px", "letter-spacing", "0px", "line-height", "1.25", "stroke-width", ".22304", "word-spacing", "0px"], ["x", "115.42167", "y", "121.30454", 2, "fill", "#ffffff", "font-size", "4.1635px", "stroke-width", ".22304"], ["target", "_blank", "href", "https://en.wikipedia.org/wiki/Friis_formulas_for_noise#The_Friis_formula_for_noise_temperature"]], template: function SimpleDocumentationComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        ɵɵelement(18, "circle", 17);
        ɵɵelementStart(19, "text", 18);
        ɵɵelementStart(20, "tspan", 19);
        ɵɵelementStart(21, "tspan", 19);
        ɵɵtext(22, "HORIZON LINE");
        ɵɵelementEnd();
        ɵɵelementEnd();
        ɵɵelementEnd();
        ɵɵelementStart(23, "text", 20);
        ɵɵelementStart(24, "tspan", 21);
        ɵɵelementStart(25, "tspan", 21);
        ɵɵtext(26, "SLANT RANGE");
        ɵɵelementEnd();
        ɵɵelementEnd();
        ɵɵelementEnd();
        ɵɵelementStart(27, "text", 22);
        ɵɵelementStart(28, "tspan", 23);
        ɵɵelementStart(29, "tspan", 23);
        ɵɵtext(30, "ALTITUDE");
        ɵɵelementEnd();
        ɵɵelementEnd();
        ɵɵelementEnd();
        ɵɵelementStart(31, "text", 24);
        ɵɵelementStart(32, "tspan", 25);
        ɵɵelementStart(33, "tspan", 25);
        ɵɵtext(34, "MINIMUM ELEVATION");
        ɵɵelementEnd();
        ɵɵelementEnd();
        ɵɵelementEnd();
        ɵɵelementStart(35, "g", 26);
        ɵɵelement(36, "path", 27);
        ɵɵelement(37, "rect", 28);
        ɵɵelement(38, "rect", 29);
        ...
        ɵɵelement(41, "ng-katex-html", 32);
        ɵɵelementEnd();
        ɵɵelementEnd();
        ɵɵtemplate(42, SimpleDocumentationComponent_div_42_Template, 15, 0, "div", 33);
        ɵɵtemplate(43, SimpleDocumentationComponent_div_43_Template, 70, 8, "div", 33);
        ɵɵtemplate(44, SimpleDocumentationComponent_div_44_Template, 58, 1, "div", 33);
    } if (rf & 2) {
        ɵɵproperty("ngClass", ɵɵpureFunction1(5, _c0$4, ctx.component !== "geometry"));
        ɵɵadvance(41);
        ɵɵproperty("html", ctx.geometry);
        ɵɵadvance(1);
        ɵɵproperty("ngIf", ctx.component == "ULCarrier" || ctx.component == "DLCarrier");
        ɵɵadvance(1);
        ɵɵproperty("ngIf", ctx.component == "ULTransmitter" || ctx.component == "DLTransmitter");
        ɵɵadvance(1);
        ɵɵproperty("ngIf", ctx.component == "ULReceiver" || ctx.component == "DLReceiver");
    } }, directives: [NgClass, ɵc, NgIf], pipes: [JsonPipe], styles: ["svg[_ngcontent-%COMP%]{height:auto;width:85%}.column[_ngcontent-%COMP%]{min-width:320px}"], changeDetection: 0 });
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵsetClassMetadata(SimpleDocumentationComponent, [{
        type: Component,
        args: [{
    ...
    }], function () { return [{ type: FormService }, { type: LoggerService }, { type: ChangeDetectorRef }]; }, { component: [{
            type: Input
        }] }); })();

class ComputeLinkBudgetService {
...
ComputeLinkBudgetService.ɵfac = function ComputeLinkBudgetService_Factory(t) { return new (t || ComputeLinkBudgetService)(ɵɵinject(ENVIRONMENT_TOKEN), ɵɵinject(HttpClient), ɵɵinject(FormService), ɵɵinject(LoggerService)); };
ComputeLinkBudgetService.ɵprov = ɵɵdefineInjectable({ token: ComputeLinkBudgetService, factory: ComputeLinkBudgetService.ɵfac, providedIn: 'root' });
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵsetClassMetadata(ComputeLinkBudgetService, [{
        type: Injectable,
        args: [{
                providedIn: 'root',
            }]
                ...
                type: Inject,
                args: [ENVIRONMENT_TOKEN]
            }] }, { type: HttpClient }, { type: FormService }, { type: LoggerService }]; }, null); })();

class DrawingDefault {
}
...
/* eslint-disable max-classes-per-file */
class SyntheticDrawingFormService {
    constructor() {
        /**
...
SyntheticDrawingFormService.ɵprov = ɵɵdefineInjectable({ token: SyntheticDrawingFormService, factory: SyntheticDrawingFormService.ɵfac, providedIn: 'root' });
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵsetClassMetadata(SyntheticDrawingFormService, [{
        type: Injectable,
        args: [{
                providedIn: 'root',
            }]
...
const _c0$5 = ["diagram"];
function SyntheticDrawingComponent__svg_svg_3_Template(rf, ctx) { if (rf & 1) {
    ɵɵnamespaceSVG();
    ɵɵelementStart(0, "svg", 4);
    ɵɵelementStart(1, "defs");
    ɵɵelementStart(2, "svg", 5);
    ɵɵelementStart(3, "defs");
    ɵɵelementStart(4, "linearGradient", 6);
    ɵɵelement(5, "stop", 7);
    ɵɵelement(6, "stop", 8);
    ɵɵelementEnd();
    ɵɵelementStart(7, "linearGradient", 9);
    ɵɵelement(8, "stop", 10);
    ɵɵelement(9, "stop", 11);
    ɵɵelementEnd();
    ɵɵelementStart(10, "marker", 12);
    ɵɵelement(11, "path", 13);
    ɵɵelementEnd();
    ɵɵelementEnd();
    ɵɵelementStart(12, "g", 14);
    ɵɵelementStart(13, "g", 15);
    ɵɵelement(14, "path", 16);
    ɵɵelementStart(15, "text", 17);
    ɵɵelementStart(16, "tspan", 18);
    ɵɵtext(17, "Tx");
    ɵɵelementEnd();
    ɵɵelementEnd();
    ɵɵelement(18, "path", 19);
    ɵɵelementStart(19, "text", 20);
    ɵɵelementStart(20, "tspan", 21);
    ɵɵtext(21, "Ground Segment");
    ɵɵelementEnd();
    ɵɵelementEnd();
    ɵɵelement(22, "image", 22);
    ɵɵelementStart(23, "text", 23);
    ɵɵelementStart(24, "tspan", 24);
    ɵɵtext(25, "Space Segment");
    ɵɵelementEnd();
    ɵɵelementEnd();
    ɵɵelementStart(26, "g", 25);
    ɵɵelement(27, "path", 26);
    ɵɵelement(28, "rect", 27);
    ɵɵelement(29, "rect", 28);
    ...
    ɵɵelementEnd();
    ɵɵelementStart(33, "g", 32);
    ɵɵelement(34, "path", 33);
    ɵɵelement(35, "path", 34);
    ɵɵelement(36, "path", 35);
    ɵɵelementEnd();
    ɵɵelementStart(37, "g", 36);
    ɵɵelementStart(38, "g", 37);
    ɵɵelementStart(39, "g", 37);
    ɵɵelement(40, "path", 38);
    ɵɵelement(41, "path", 39);
    ɵɵelement(42, "path", 40);
    ɵɵelementEnd();
    ɵɵelementEnd();
    ɵɵelementEnd();
    ɵɵelementStart(43, "g", 41);
    ɵɵelement(44, "path", 42);
    ɵɵelementEnd();
    ɵɵelementStart(45, "g", 43);
    ɵɵelementStart(46, "g", 44);
    ɵɵelement(47, "path", 45);
    ɵɵelementEnd();
    ɵɵelementStart(48, "text", 46);
    ɵɵelementStart(49, "tspan", 47);
    ɵɵtext(50, "Rx");
    ɵɵelementEnd();
    ɵɵelementEnd();
    ɵɵelementEnd();
...
function SyntheticDrawingComponent__svg_svg_4_Template(rf, ctx) { if (rf & 1) {
    ɵɵnamespaceSVG();
    ɵɵelementStart(0, "svg", 4);
    ɵɵelementStart(1, "defs");
    ...
    ɵɵelement(6, "stop", 8);
    ɵɵelementEnd();
    ɵɵelementStart(7, "linearGradient", 50);
    ɵɵelement(8, "stop", 10);
    ɵɵelement(9, "stop", 11);
    ɵɵelementEnd();
    ɵɵelementStart(10, "marker", 12);
    ...
    ɵɵelementEnd();
    ɵɵelementEnd();
    ɵɵelementStart(12, "g", 51);
    ɵɵelementStart(13, "g", 52);
    ɵɵelement(14, "path", 16);
    ɵɵelementStart(15, "text", 53);
    ɵɵelementStart(16, "tspan", 54);
    ɵɵtext(17, "Tx");
    ɵɵelementEnd();
    ɵɵelementEnd();
    ɵɵelement(18, "path", 55);
    ɵɵelementEnd();
    ɵɵelementStart(19, "g", 56);
    ɵɵelement(20, "path", 31);
    ɵɵelementEnd();
    ɵɵelementStart(21, "g", 57);
    ɵɵelement(22, "path", 33);
    ɵɵelement(23, "path", 34);
    ɵɵelement(24, "path", 35);
    ɵɵelementEnd();
    ɵɵelementStart(25, "g", 58);
    ɵɵelementStart(26, "g", 37);
    ɵɵelementStart(27, "g", 37);
    ɵɵelement(28, "path", 38);
    ɵɵelement(29, "path", 39);
    ɵɵelement(30, "path", 40);
    ɵɵelementEnd();
    ɵɵelementEnd();
    ɵɵelementEnd();
    ɵɵelementStart(31, "g", 59);
    ɵɵelement(32, "path", 42);
    ɵɵelementEnd();
    ɵɵelementStart(33, "g", 60);
    ɵɵelementStart(34, "g", 61);
    ɵɵelement(35, "path", 45);
    ɵɵelementEnd();
    ɵɵelementStart(36, "text", 62);
    ɵɵelementStart(37, "tspan", 63);
    ɵɵtext(38, "Rx");
    ɵɵelementEnd();
    ɵɵelementEnd();
    ɵɵelementEnd();
    ɵɵelementEnd();
    ɵɵelementStart(39, "text", 64);
    ɵɵelementStart(40, "tspan", 65);
    ɵɵtext(41, "Ground Segment");
    ɵɵelementEnd();
    ɵɵelementEnd();
    ɵɵelementStart(42, "text", 66);
    ɵɵelementStart(43, "tspan", 67);
    ɵɵtext(44, "Space Segment");
    ɵɵelementEnd();
    ɵɵelementEnd();
    ɵɵelementStart(45, "g", 68);
    ɵɵelement(46, "path", 26);
    ɵɵelement(47, "rect", 27);
    ɵɵelement(48, "rect", 28);
    ɵɵelement(49, "path", 29);
    ɵɵelementEnd();
    ɵɵelement(50, "image", 69);
    ɵɵelementEnd();
    ɵɵelementEnd();
    ɵɵelement(51, "use", 70);
    ɵɵelementEnd();
} }
class SyntheticDrawingComponent {
    constructor(drawingService, logger) {
    ...
    updateLBScenario(power, components, linkType) {
    ...
    initGraph() {
        ...
        this.mainSVG = select(this.diagram.nativeElement)
            .append('svg')
            .attr('id', 'graph')
    ...
    updateGraphData(newScenario) {
        ...
        const [min, max] = (_a = (extent(points, (point) => point.y))) !== null && _a !== void 0 ? _a : [0, -150];
        this.y.domain([max, min]);
        const valueline = line()
            .x((d) => { var _a; return (_a = x(d.x)) !== null && _a !== void 0 ? _a : x(0); })
            .y((d) => { var _a; return (_a = y(d.y)) !== null && _a !== void 0 ? _a : y(0); });
...
function ResultsComponent_lib_card_0_ng_container_11_ng_container_7_ng_container_1_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵɵadvance(1);
    ɵɵproperty("ngClass", ɵɵpureFunction1(7, _c0$6, ctx_r6.showUplink ? ctx_r6.deltaUL.includes(elt_r7.name) : ctx_r6.deltaDL.includes(elt_r7.name)));
    ɵɵadvance(2);
    ɵɵtextInterpolate(ctx_r6.params[elt_r7.name].label);
    ɵɵadvance(2);
    ɵɵtextInterpolate2(" ", ɵɵpipeBind2(6, 4, elt_r7.value, ".1-2"), " ", elt_r7.unit, " ");
} }
function ResultsComponent_lib_card_0_ng_container_11_ng_container_7_Template(rf, ctx) { if (rf & 1) {
    ɵɵelementContainerStart(0);
    ɵɵtemplate(1, ResultsComponent_lib_card_0_ng_container_11_ng_container_7_ng_container_1_Template, 7, 9, "ng-container", 14);
    ɵɵelementContainerEnd();
} if (rf & 2) {
    const section_r4 = ɵɵnextContext().$implicit;
    ɵɵadvance(1);
    ɵɵproperty("ngForOf", section_r4.elt);
} }
function ResultsComponent_lib_card_0_ng_container_11_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵɵlistener("click", function ResultsComponent_lib_card_0_ng_container_11_Template_a_click_4_listener() { ɵɵrestoreView(_r10); const section_r4 = ctx.$implicit; const ctx_r9 = ɵɵnextContext(2); return ctx_r9.showUplink ? (ctx_r9.collapsed.uplink[section_r4.group] = !ctx_r9.collapsed.uplink[section_r4.group]) : (ctx_r9.collapsed.downlink[section_r4.group] = !ctx_r9.collapsed.downlink[section_r4.group]); });
    ɵɵelementStart(5, "span", 17);
    ɵɵelement(6, "fa-icon", 18);
    ɵɵelementEnd();
    ɵɵelementEnd();
    ɵɵelementEnd();
    ɵɵtemplate(7, ResultsComponent_lib_card_0_ng_container_11_ng_container_7_Template, 2, 1, "ng-container", 0);
    ɵɵelementContainerEnd();
} if (rf & 2) {
    const section_r4 = ctx.$implicit;
    const ctx_r3 = ɵɵnextContext(2);
    ɵɵadvance(3);
    ɵɵtextInterpolate(section_r4.group);
    ɵɵadvance(3);
    ɵɵpropertyInterpolate1("transform", "rotate-", (ctx_r3.showUplink ? ctx_r3.collapsed.uplink[section_r4.group] : ctx_r3.collapsed.downlink[section_r4.group]) ? 0 : 180, "");
    ɵɵproperty("icon", ctx_r3.faAngleDown);
    ɵɵadvance(1);
    ɵɵproperty("ngIf", ctx_r3.showUplink ? !ctx_r3.collapsed.uplink[section_r4.group] : !ctx_r3.collapsed.downlink[section_r4.group]);
} }
const _c1$2 = function (a0) { return { "is-active": a0 }; };
function ResultsComponent_lib_card_0_Template(rf, ctx) { if (rf & 1) {
    const _r12 = ɵɵgetCurrentView();
    ɵɵelementStart(0, "lib-card");
    ɵɵelementStart(1, "div", 10);
    ɵɵelementStart(2, "ul", 11);
    ɵɵelementStart(3, "li", 12);
    ɵɵlistener("click", function ResultsComponent_lib_card_0_Template_li_click_3_listener() { ɵɵrestoreView(_r12); const ctx_r11 = ɵɵnextContext(); return ctx_r11.showUplink = true; });
    ɵɵelementStart(4, "a");
    ɵɵtext(5, "Uplink");
    ɵɵelementEnd();
    ɵɵelementEnd();
    ɵɵelementStart(6, "li", 12);
    ɵɵlistener("click", function ResultsComponent_lib_card_0_Template_li_click_6_listener() { ɵɵrestoreView(_r12); const ctx_r13 = ɵɵnextContext(); return ctx_r13.showUplink = false; });
    ɵɵelementStart(7, "a");
    ɵɵtext(8, "Downlink");
    ɵɵelementEnd();
    ɵɵelementEnd();
    ɵɵelementEnd();
    ɵɵelementEnd();
    ɵɵelementStart(9, "table", 13);
    ɵɵelementStart(10, "tbody");
    ɵɵtemplate(11, ResultsComponent_lib_card_0_ng_container_11_Template, 8, 4, "ng-container", 14);
    ɵɵelementEnd();
    ɵɵelementEnd();
    ɵɵelementEnd();
} if (rf & 2) {
    const ctx_r0 = ɵɵnextContext();
    ɵɵadvance(3);
    ɵɵproperty("ngClass", ɵɵpureFunction1(4, _c1$2, ctx_r0.showUplink));
    ɵɵadvance(3);
    ɵɵproperty("ngClass", ɵɵpureFunction1(6, _c1$2, !ctx_r0.showUplink));
    ɵɵadvance(3);
    ɵɵproperty("ngClass", ctx_r0.showUplink ? "animate__slideInLeft" : "animate__slideInRight");
    ɵɵadvance(2);
    ɵɵproperty("ngForOf", ctx_r0.showUplink ? ctx_r0.fullResult2.uplink : ctx_r0.fullResult2.downlink);
} }
function ResultsComponent_lib_navigation_sidebar_2_Template(rf, ctx) { if (rf & 1) {
    ɵɵelement(0, "lib-navigation-sidebar", 22);
} if (rf & 2) {
    ɵɵproperty("currentComponent", "results");
} }
function ResultsComponent_div_15_lib_card_3_fa_icon_2_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵɵproperty("icon", ctx_r18.faCheck);
} }
function ResultsComponent_div_15_lib_card_3_fa_icon_3_Template(rf, ctx) { if (rf & 1) {
    ɵɵelement(0, "fa-icon", 33);
} if (rf & 2) {
    const ctx_r19 = ɵɵnextContext(3);
    ɵɵproperty("icon", ctx_r19.faWarn);
} }
function ResultsComponent_div_15_lib_card_3_fa_icon_4_Template(rf, ctx) { if (rf & 1) {
    ɵɵelement(0, "fa-icon", 33);
} if (rf & 2) {
    const ctx_r20 = ɵɵnextContext(3);
    ɵɵproperty("icon", ctx_r20.faError);
} }
function ResultsComponent_div_15_lib_card_3_Template(rf, ctx) { if (rf & 1) {
    ɵɵelementStart(0, "lib-card", 29);
    ɵɵelementStart(1, "div", 30);
    ɵɵtemplate(2, ResultsComponent_div_15_lib_card_3_fa_icon_2_Template, 1, 1, "fa-icon", 31);
    ɵɵtemplate(3, ResultsComponent_div_15_lib_card_3_fa_icon_3_Template, 1, 1, "fa-icon", 31);
    ɵɵtemplate(4, ResultsComponent_div_15_lib_card_3_fa_icon_4_Template, 1, 1, "fa-icon", 31);
    ɵɵelement(5, "p", 32);
    ɵɵelementEnd();
    ɵɵelementEnd();
} if (rf & 2) {
    const ctx_r14 = ɵɵnextContext(2);
    ɵɵproperty("styleClass", ctx_r14.linkStatus.uplink.status || "");
    ɵɵadvance(2);
    ɵɵproperty("ngIf", ctx_r14.linkStatus.uplink.status === "is-success");
    ɵɵadvance(1);
    ɵɵproperty("ngIf", ctx_r14.linkStatus.uplink.status === "is-warning");
    ɵɵadvance(1);
    ɵɵproperty("ngIf", ctx_r14.linkStatus.uplink.status === "is-danger");
    ɵɵadvance(1);
    ɵɵproperty("innerHTML", ctx_r14.linkStatus.uplink.message, ɵɵsanitizeHtml);
} }
function ResultsComponent_div_15_ng_container_6_ng_container_7_ng_container_1_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵɵadvance(1);
    ɵɵproperty("ngClass", ɵɵpureFunction1(7, _c0$6, ctx_r23.deltaUL.includes(elt_r24.name)));
    ɵɵadvance(2);
    ɵɵtextInterpolate(ctx_r23.params[elt_r24.name].label);
    ɵɵadvance(2);
    ɵɵtextInterpolate2(" ", ɵɵpipeBind2(6, 4, elt_r24.value, ".1-2"), " ", elt_r24.unit, " ");
} }
function ResultsComponent_div_15_ng_container_6_ng_container_7_Template(rf, ctx) { if (rf & 1) {
    ɵɵelementContainerStart(0);
    ɵɵtemplate(1, ResultsComponent_div_15_ng_container_6_ng_container_7_ng_container_1_Template, 7, 9, "ng-container", 14);
    ɵɵelementContainerEnd();
} if (rf & 2) {
    const section_r21 = ɵɵnextContext().$implicit;
    ɵɵadvance(1);
    ɵɵproperty("ngForOf", section_r21.elt);
} }
function ResultsComponent_div_15_ng_container_6_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵɵelementEnd();
    ɵɵelementStart(4, "a", 16);
    ɵɵlistener("click", function ResultsComponent_div_15_ng_container_6_Template_a_click_4_listener() { ɵɵrestoreView(_r27); const section_r21 = ctx.$implicit; const ctx_r26 = ɵɵnextContext(2); return (ctx_r26.collapsed.uplink[section_r21.group] = !ctx_r26.collapsed.uplink[section_r21.group]); });
    ɵɵelementStart(5, "span", 17);
    ɵɵelement(6, "fa-icon", 18);
    ɵɵelementEnd();
    ɵɵelementEnd();
    ɵɵelementEnd();
    ɵɵtemplate(7, ResultsComponent_div_15_ng_container_6_ng_container_7_Template, 2, 1, "ng-container", 0);
    ɵɵelementContainerEnd();
} if (rf & 2) {
    const section_r21 = ctx.$implicit;
    const ctx_r15 = ɵɵnextContext(2);
    ɵɵadvance(3);
    ɵɵtextInterpolate(section_r21.group);
    ɵɵadvance(3);
    ɵɵpropertyInterpolate1("transform", "rotate-", ctx_r15.collapsed.uplink[section_r21.group] ? 0 : 180, "");
    ɵɵproperty("icon", ctx_r15.faAngleDown);
    ɵɵadvance(1);
    ɵɵproperty("ngIf", !ctx_r15.collapsed.uplink[section_r21.group]);
} }
function ResultsComponent_div_15_lib_card_14_fa_icon_2_Template(rf, ctx) { if (rf & 1) {
    ɵɵelement(0, "fa-icon", 33);
} if (rf & 2) {
    const ctx_r28 = ɵɵnextContext(3);
    ɵɵproperty("icon", ctx_r28.faCheck);
} }
function ResultsComponent_div_15_lib_card_14_fa_icon_3_Template(rf, ctx) { if (rf & 1) {
    ɵɵelement(0, "fa-icon", 33);
} if (rf & 2) {
    const ctx_r29 = ɵɵnextContext(3);
    ɵɵproperty("icon", ctx_r29.faWarn);
} }
function ResultsComponent_div_15_lib_card_14_fa_icon_4_Template(rf, ctx) { if (rf & 1) {
    ɵɵelement(0, "fa-icon", 33);
} if (rf & 2) {
    const ctx_r30 = ɵɵnextContext(3);
    ɵɵproperty("icon", ctx_r30.faError);
} }
function ResultsComponent_div_15_lib_card_14_Template(rf, ctx) { if (rf & 1) {
    ɵɵelementStart(0, "lib-card", 29);
    ɵɵelementStart(1, "div", 30);
    ɵɵtemplate(2, ResultsComponent_div_15_lib_card_14_fa_icon_2_Template, 1, 1, "fa-icon", 31);
    ɵɵtemplate(3, ResultsComponent_div_15_lib_card_14_fa_icon_3_Template, 1, 1, "fa-icon", 31);
    ɵɵtemplate(4, ResultsComponent_div_15_lib_card_14_fa_icon_4_Template, 1, 1, "fa-icon", 31);
    ɵɵelement(5, "p", 32);
    ɵɵelementEnd();
    ɵɵelementEnd();
} if (rf & 2) {
    const ctx_r16 = ɵɵnextContext(2);
    ɵɵproperty("styleClass", ctx_r16.linkStatus.downlink.status || "");
    ɵɵadvance(2);
    ɵɵproperty("ngIf", ctx_r16.linkStatus.downlink.status === "is-success");
    ɵɵadvance(1);
    ɵɵproperty("ngIf", ctx_r16.linkStatus.downlink.status === "is-warning");
    ɵɵadvance(1);
    ɵɵproperty("ngIf", ctx_r16.linkStatus.downlink.status === "is-danger");
    ɵɵadvance(1);
    ɵɵproperty("innerHTML", ctx_r16.linkStatus.downlink.message, ɵɵsanitizeHtml);
} }
function ResultsComponent_div_15_ng_container_17_ng_container_7_ng_container_1_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵɵadvance(1);
    ɵɵproperty("ngClass", ɵɵpureFunction1(7, _c0$6, ctx_r33.deltaDL.includes(elt_r34.name)));
    ɵɵadvance(2);
    ɵɵtextInterpolate(ctx_r33.params[elt_r34.name].label);
    ɵɵadvance(2);
    ɵɵtextInterpolate2(" ", ɵɵpipeBind2(6, 4, elt_r34.value, ".1-2"), " ", elt_r34.unit, " ");
} }
function ResultsComponent_div_15_ng_container_17_ng_container_7_Template(rf, ctx) { if (rf & 1) {
    ɵɵelementContainerStart(0);
    ɵɵtemplate(1, ResultsComponent_div_15_ng_container_17_ng_container_7_ng_container_1_Template, 7, 9, "ng-container", 14);
    ɵɵelementContainerEnd();
} if (rf & 2) {
    const section_r31 = ɵɵnextContext().$implicit;
    ɵɵadvance(1);
    ɵɵproperty("ngForOf", section_r31.elt);
} }
function ResultsComponent_div_15_ng_container_17_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵɵelementEnd();
    ɵɵelementStart(4, "a", 16);
    ɵɵlistener("click", function ResultsComponent_div_15_ng_container_17_Template_a_click_4_listener() { ɵɵrestoreView(_r37); const section_r31 = ctx.$implicit; const ctx_r36 = ɵɵnextContext(2); return (ctx_r36.collapsed.downlink[section_r31.group] = !ctx_r36.collapsed.downlink[section_r31.group]); });
    ɵɵelementStart(5, "span", 17);
    ɵɵelement(6, "fa-icon", 18);
    ɵɵelementEnd();
    ɵɵelementEnd();
    ɵɵelementEnd();
    ɵɵtemplate(7, ResultsComponent_div_15_ng_container_17_ng_container_7_Template, 2, 1, "ng-container", 0);
    ɵɵelementContainerEnd();
} if (rf & 2) {
    const section_r31 = ctx.$implicit;
    const ctx_r17 = ɵɵnextContext(2);
    ɵɵadvance(3);
    ɵɵtextInterpolate(section_r31.group);
    ɵɵadvance(3);
    ɵɵpropertyInterpolate1("transform", "rotate-", ctx_r17.collapsed.downlink[section_r31.group] ? 0 : 180, "");
    ɵɵproperty("icon", ctx_r17.faAngleDown);
    ɵɵadvance(1);
    ɵɵproperty("ngIf", !ctx_r17.collapsed.downlink[section_r31.group]);
} }
function ResultsComponent_div_15_Template(rf, ctx) { if (rf & 1) {
    ɵɵelementStart(0, "div", 1);
    ɵɵelementStart(1, "div", 23);
    ɵɵelementStart(2, "lib-card", 24);
    ɵɵtemplate(3, ResultsComponent_div_15_lib_card_3_Template, 6, 5, "lib-card", 25);
    ɵɵelementStart(4, "table", 26);
    ɵɵelementStart(5, "tbody");
    ɵɵtemplate(6, ResultsComponent_div_15_ng_container_6_Template, 8, 4, "ng-container", 14);
    ɵɵelementEnd();
    ɵɵelementEnd();
    ɵɵelementEnd();
    ɵɵelementEnd();
    ɵɵelementStart(7, "div", 27);
    ɵɵelementStart(8, "lib-card", 24);
    ɵɵelement(9, "lib-synthetic-drawing", 28);
    ɵɵelementEnd();
    ɵɵelementStart(10, "lib-card", 24);
    ɵɵelement(11, "lib-synthetic-drawing", 28);
    ɵɵelementEnd();
    ɵɵelementEnd();
    ɵɵelementStart(12, "div", 23);
    ɵɵelementStart(13, "lib-card", 24);
    ɵɵtemplate(14, ResultsComponent_div_15_lib_card_14_Template, 6, 5, "lib-card", 25);
    ɵɵelementStart(15, "table", 26);
    ɵɵelementStart(16, "tbody");
    ɵɵtemplate(17, ResultsComponent_div_15_ng_container_17_Template, 8, 4, "ng-container", 14);
    ɵɵelementEnd();
    ɵɵelementEnd();
    ɵɵelementEnd();
    ɵɵelementEnd();
    ...
    const ctx_r2 = ɵɵnextContext();
    ɵɵadvance(2);
    ɵɵproperty("title", "Uplink");
    ɵɵadvance(1);
    ɵɵproperty("ngIf", ctx_r2.linkStatus);
    ɵɵadvance(3);
    ɵɵproperty("ngForOf", ctx_r2.fullResult2.uplink);
    ɵɵadvance(2);
    ɵɵproperty("title", "Synthesis Uplink");
    ɵɵadvance(1);
    ɵɵproperty("scenarioId", "uplink")("components", ctx_r2.diagramParamsUplink.diagramComponents)("linkType", "uplink")("powerIn", ctx_r2.diagramParamsUplink.powerIn);
    ɵɵadvance(1);
    ɵɵproperty("title", "Synthesis Downlink");
    ɵɵadvance(1);
    ɵɵproperty("scenarioId", "downlink")("components", ctx_r2.diagramParamsDownlink.diagramComponents)("linkType", "downlink")("powerIn", ctx_r2.diagramParamsDownlink.powerIn);
    ɵɵadvance(2);
    ɵɵproperty("title", "Downlink");
    ɵɵadvance(1);
    ɵɵproperty("ngIf", ctx_r2.linkStatus);
    ɵɵadvance(3);
    ɵɵproperty("ngForOf", ctx_r2.fullResult2.downlink);
} }
...
function ResultSidebarComponent_lib_results_0_Template(rf, ctx) { if (rf & 1) {
    ɵɵelement(0, "lib-results", 2);
} if (rf & 2) {
    ɵɵproperty("minimal", true);
} }
function ResultSidebarComponent_button_1_Template(rf, ctx) { if (rf & 1) {
    const _r3 = ɵɵgetCurrentView();
    ɵɵelementStart(0, "button", 3);
    ɵɵlistener("click", function ResultSidebarComponent_button_1_Template_button_click_0_listener() { ɵɵrestoreView(_r3); const ctx_r2 = ɵɵnextContext(); return ctx_r2.computeLinkBudget.toggleResults(); });
    ɵɵtext(1);
    ɵɵelementEnd();
} if (rf & 2) {
    const ctx_r1 = ɵɵnextContext();
    ɵɵadvance(1);
    ɵɵtextInterpolate1(" ", ctx_r1.computeLinkBudget.displayingResults ? ">" : "<", " ");
} }
class ResultSidebarComponent {
    constructor(computeLinkBudget) {
        this.computeLinkBudget = computeLinkBudget;
    }
}
ResultSidebarComponent.ɵfac = function ResultSidebarComponent_Factory(t) { return new (t || ResultSidebarComponent)(ɵɵdirectiveInject(ComputeLinkBudgetService)); };
ResultSidebarComponent.ɵcmp = ɵɵdefineComponent({ type: ResultSidebarComponent, selectors: [["lib-result-sidebar"]], decls: 2, vars: 2, consts: [[3, "minimal", 4, "ngIf"], ["class", "button", "style", "position: fixed; bottom: 10px; right: 10px", 3, "click", 4, "ngIf"], [3, "minimal"], [1, "button", 2, "position", "fixed", "bottom", "10px", "right", "10px", 3, "click"]], template: function ResultSidebarComponent_Template(rf, ctx) { if (rf & 1) {
        ɵɵtemplate(0, ResultSidebarComponent_lib_results_0_Template, 1, 1, "lib-results", 0);
        ɵɵtemplate(1, ResultSidebarComponent_button_1_Template, 2, 1, "button", 1);
    } if (rf & 2) {
        ɵɵproperty("ngIf", ctx.computeLinkBudget.displayingResults);
        ɵɵadvance(1);
        ɵɵproperty("ngIf", ctx.computeLinkBudget.computeLayout == "sidebar");
    } }, directives: [NgIf, ResultsComponent], styles: [""] });
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵsetClassMetadata(ResultSidebarComponent, [{
        type: Component,
        args: [{
...
SaveLoadService.ɵfac = function SaveLoadService_Factory(t) { return new (t || SaveLoadService)(ɵɵinject(ENVIRONMENT_TOKEN), ɵɵinject(LoggerService), ɵɵinject(FormService), ɵɵinject(FormBuilder)); };
SaveLoadService.ɵprov = ɵɵdefineInjectable({ token: SaveLoadService, factory: SaveLoadService.ɵfac, providedIn: 'root' });
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵsetClassMetadata(SaveLoadService, [{
        type: Injectable,
        args: [{
                providedIn: 'root',
            }]
                ...
                type: Inject,
                args: [ENVIRONMENT_TOKEN]
            }] }, { type: LoggerService }, { type: FormService }, { type: FormBuilder }]; }, null); })();

class JSatOrbLinkService {
...
JSatOrbLinkService.ɵfac = function JSatOrbLinkService_Factory(t) { return new (t || JSatOrbLinkService)(ɵɵinject(FormService), ɵɵinject(LoggerService), ɵɵinject(SaveLoadService), ɵɵinject(ENVIRONMENT_TOKEN)); };
JSatOrbLinkService.ɵprov = ɵɵdefineInjectable({ token: JSatOrbLinkService, factory: JSatOrbLinkService.ɵfac, providedIn: 'root' });
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵsetClassMetadata(JSatOrbLinkService, [{
        type: Injectable,
        args: [{
                providedIn: 'root',
            }]
    }], function () { return [{ type: FormService }, { type: LoggerService }, { type: SaveLoadService }, { type: undefined, decorators: [{
                type: Inject,
                args: [ENVIRONMENT_TOKEN]
            }] }]; }, null); })();
...
function JSatOrbLinkComponent_form_0_option_8_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵɵproperty("ngValue", satellite_r4);
    ɵɵadvance(1);
    ɵɵtextInterpolate(satellite_r4.name);
} }
function JSatOrbLinkComponent_form_0_option_14_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵɵproperty("ngValue", station_r5);
    ɵɵadvance(1);
    ɵɵtextInterpolate(station_r5.name);
} }
function JSatOrbLinkComponent_form_0_Template(rf, ctx) { if (rf & 1) {
    const _r7 = ɵɵgetCurrentView();
    ɵɵelementStart(0, "form", 2);
    ɵɵlistener("ngSubmit", function JSatOrbLinkComponent_form_0_Template_form_ngSubmit_0_listener() { ɵɵrestoreView(_r7); const ctx_r6 = ɵɵnextContext(); return ctx_r6.importJSO(); });
    ...
    ɵɵtemplate(8, JSatOrbLinkComponent_form_0_option_8_Template, 2, 2, "option", 9);
    ɵɵelementEnd();
    ɵɵelementEnd();
    ɵɵelementEnd();
    ...
    ɵɵtemplate(14, JSatOrbLinkComponent_form_0_option_14_Template, 2, 2, "option", 9);
    ɵɵelementEnd();
    ɵɵelementEnd();
    ɵɵelementEnd();
    ɵɵelementEnd();
    ...
    ɵɵadvance(8);
    ɵɵproperty("ngForOf", ctx_r0.jsoData.satellites);
    ɵɵadvance(6);
    ɵɵproperty("ngForOf", ctx_r0.jsoData.groundStations);
} }
function JSatOrbLinkComponent_div_1_Template(rf, ctx) { if (rf & 1) {
    ɵɵelementStart(0, "div");
    ɵɵelementStart(1, "p");
    ɵɵtext(2, "It seems no scenario has been imported inside JSatOrb.");
    ɵɵelement(3, "br");
    ɵɵtext(4, "Luplink won't be able to import data from JSatOrb.");
    ɵɵelementEnd();
    ɵɵelementEnd();
} }
class JSatOrbLinkComponent {
...
JSatOrbLinkComponent.ɵfac = function JSatOrbLinkComponent_Factory(t) { return new (t || JSatOrbLinkComponent)(ɵɵdirectiveInject(JSatOrbLinkService), ɵɵdirectiveInject(LoggerService), ɵɵdirectiveInject(SaveLoadService)); };
JSatOrbLinkComponent.ɵcmp = ɵɵdefineComponent({ type: JSatOrbLinkComponent, selectors: [["lib-luplink-jsatorb-import"]], decls: 2, vars: 2, consts: [["class", "form", 3, "formGroup", "ngSubmit", 4, "ngIf"], [4, "ngIf"], [1, "form", 3, "formGroup", "ngSubmit"], [1, "field", "is-horizontal"], [1, "field-body"], [1, "field"], [1, "label"], [1, "select", "is-fullwidth"], ["formControlName", "satellite"], [3, "ngValue", 4, "ngFor", "ngForOf"], [1, "field", "is-expanded"], ["formControlName", "station"], [1, "field", "is-grouped", "is-grouped-right"], [1, "control"], ["type", "submit", 1, "button", "is-primary"], [3, "ngValue"]], template: function JSatOrbLinkComponent_Template(rf, ctx) { if (rf & 1) {
        ɵɵtemplate(0, JSatOrbLinkComponent_form_0_Template, 21, 3, "form", 0);
        ɵɵtemplate(1, JSatOrbLinkComponent_div_1_Template, 5, 0, "div", 1);
    } if (rf & 2) {
        ɵɵproperty("ngIf", !ctx.isEmpty);
        ɵɵadvance(1);
        ɵɵproperty("ngIf", ctx.isEmpty);
    } }, directives: [NgIf, ɵangular_packages_forms_forms_ba, NgControlStatusGroup, FormGroupDirective, SelectControlValueAccessor, NgControlStatus, FormControlName, NgForOf, NgSelectOption, ɵangular_packages_forms_forms_z], styles: [""] });
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵsetClassMetadata(JSatOrbLinkComponent, [{
        type: Component,
        args: [{
...
function LayoutComponent_div_6_lib_card_2_Template(rf, ctx) { if (rf & 1) {
    ɵɵelementStart(0, "lib-card", 14);
    ɵɵelement(1, "lib-luplink-jsatorb-import");
    ɵɵelementEnd();
} if (rf & 2) {
    ɵɵproperty("title", "Import from JSatOrb");
} }
const _c0$7 = function (a0) { return { "is-hidden": a0 }; };
function LayoutComponent_div_6_Template(rf, ctx) { if (rf & 1) {
    const _r4 = ɵɵgetCurrentView();
    ɵɵelementStart(0, "div", 11);
    ɵɵelementStart(1, "div", 12);
    ɵɵtemplate(2, LayoutComponent_div_6_lib_card_2_Template, 2, 1, "lib-card", 13);
    ɵɵelementStart(3, "lib-card", 14);
    ɵɵelementStart(4, "lib-form", 15);
    ɵɵlistener("formStatus", function LayoutComponent_div_6_Template_lib_form_formStatus_4_listener($event) { ɵɵrestoreView(_r4); const ctx_r3 = ɵɵnextContext(); return ctx_r3.handleError($event); });
    ɵɵelementEnd();
    ɵɵelementEnd();
    ɵɵelementStart(5, "lib-card", 6);
    ɵɵelementStart(6, "lib-form", 15);
    ɵɵlistener("formStatus", function LayoutComponent_div_6_Template_lib_form_formStatus_6_listener($event) { ɵɵrestoreView(_r4); const ctx_r5 = ɵɵnextContext(); return ctx_r5.handleError($event); });
    ɵɵelementEnd();
    ɵɵelementEnd();
    ɵɵelementEnd();
    ɵɵelementStart(7, "div", 12);
    ɵɵelementStart(8, "lib-card", 6);
    ɵɵelementStart(9, "lib-form", 15);
    ɵɵlistener("formStatus", function LayoutComponent_div_6_Template_lib_form_formStatus_9_listener($event) { ɵɵrestoreView(_r4); const ctx_r6 = ɵɵnextContext(); return ctx_r6.handleError($event); });
    ɵɵelementEnd();
    ɵɵelementEnd();
    ɵɵelementStart(10, "lib-card", 6);
    ɵɵelement(11, "lib-simple-documentation", 7);
    ɵɵelementEnd();
    ɵɵelementEnd();
    ɵɵelementEnd();
} if (rf & 2) {
    const ctx_r0 = ɵɵnextContext();
    ɵɵadvance(2);
    ɵɵproperty("ngIf", !ctx_r0.isStandalone && ctx_r0.componentId == "geometry");
    ɵɵadvance(1);
    ɵɵproperty("title", ctx_r0.componentName);
    ɵɵadvance(1);
    ɵɵproperty("formTemplate", ctx_r0.currentTemplate);
    ɵɵadvance(1);
    ɵɵproperty("title", "Atmosphere")("ngClass", ɵɵpureFunction1(12, _c0$7, !ctx_r0.hasAtmCard));
    ɵɵadvance(1);
    ɵɵproperty("formTemplate", ctx_r0.atmosphere);
    ɵɵadvance(2);
    ɵɵproperty("title", ctx_r0.antennaName)("ngClass", ɵɵpureFunction1(14, _c0$7, !ctx_r0.hasAntennaCard));
    ɵɵadvance(1);
    ɵɵproperty("formTemplate", ctx_r0.currentAntenna);
    ɵɵadvance(1);
    ɵɵproperty("title", "Documentation")("ngClass", ɵɵpureFunction1(16, _c0$7, ctx_r0.hasAntennaCard));
    ɵɵadvance(1);
    ɵɵproperty("component", ctx_r0.componentId);
} }
function LayoutComponent_div_12_Template(rf, ctx) { if (rf & 1) {
    ɵɵelementStart(0, "div", 16);
    ɵɵelementStart(1, "pre");
    ɵɵtext(2);
    ɵɵpipe(3, "json");
    ɵɵelementEnd();
    ɵɵelementEnd();
    ...
    const ctx_r1 = ɵɵnextContext();
    ɵɵadvance(2);
    ɵɵtextInterpolate(ɵɵpipeBind1(3, 1, ctx_r1.formService.globalForm.value));
} }
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵsetClassMetadata(LayoutComponent, [{
        ...
        args: [{
                ...
                type: Inject,
                args: [FORM_TEMPLATE_TOKEN]
            }] }, { type: FormService }, { type: ActivatedRoute }, { type: LoggerService }]; }, null); })();

class SimpleDocumentationModule {
}
SimpleDocumentationModule.ɵfac = function SimpleDocumentationModule_Factory(t) { return new (t || SimpleDocumentationModule)(); };
SimpleDocumentationModule.ɵmod = ɵɵdefineNgModule({ type: SimpleDocumentationModule });
SimpleDocumentationModule.ɵinj = ɵɵdefineInjector({ imports: [[
            CommonModule,
            FontAwesomeModule,
            FormsModule,
            LoggerModule.forRoot(),
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵɵsetNgModuleScope(SimpleDocumentationModule, { declarations: [SimpleDocumentationComponent], imports: [CommonModule,
        FontAwesomeModule,
        FormsModule, LoggerModule, KatexModule], exports: [SimpleDocumentationComponent] }); })();
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵsetClassMetadata(SimpleDocumentationModule, [{
        type: NgModule,
        args: [{
                declarations: [
                    SimpleDocumentationComponent,
...
StepbarModule.ɵmod = ɵɵdefineNgModule({ type: StepbarModule });
StepbarModule.ɵinj = ɵɵdefineInjector({ imports: [[
            CommonModule,
            FontAwesomeModule,
            LoggerModule.forRoot(),
        ]] });
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵɵsetNgModuleScope(StepbarModule, { declarations: [StepbarComponent], imports: [CommonModule,
        FontAwesomeModule, LoggerModule], exports: [StepbarComponent] }); })();
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵsetClassMetadata(StepbarModule, [{
        type: NgModule,
        args: [{
                declarations: [
                    StepbarComponent,
...
class NavigationSidebarModule {
}
NavigationSidebarModule.ɵfac = function NavigationSidebarModule_Factory(t) { return new (t || NavigationSidebarModule)(); };
NavigationSidebarModule.ɵmod = ɵɵdefineNgModule({ type: NavigationSidebarModule });
NavigationSidebarModule.ɵinj = ɵɵdefineInjector({ imports: [[CommonModule, FormsModule, FontAwesomeModule, RouterModule]] });
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵɵsetNgModuleScope(NavigationSidebarModule, { declarations: [NavigationSidebarComponent], imports: [CommonModule, FormsModule, FontAwesomeModule, RouterModule], exports: [NavigationSidebarComponent] }); })();
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵsetClassMetadata(NavigationSidebarModule, [{
        type: NgModule,
        args: [{
...
class SyntheticDrawingFormComponent {
...
SyntheticDrawingFormComponent.ɵcmp = ɵɵdefineComponent({ type: SyntheticDrawingFormComponent, selectors: [["lib-synthetic-drawing-form"]], inputs: { scenarioId: "scenarioId" }, decls: 34, vars: 1, consts: [["id", "form", 3, "formGroup"], [1, "field"], [1, "label"], ["formControlName", "power", "type", "number", 1, "input"], ["formArrayName", "gains"], ["formControlName", "cableTx", "type", "number", 1, "input"], ["formControlName", "antTx", "type", "number", 1, "input"], ["formControlName", "fsl", "type", "number", 1, "input"], ["formControlName", "antRx", "type", "number", 1, "input"], ["formControlName", "cableRx", "type", "number", 1, "input"], [1, "field", "is-grouped"], [1, "control"], ["form", "form", "type", "submit", 1, "button", "is-primary", 3, "click"], ["id", "randomize", 1, "button", "is-secondary", 3, "click"]], template: function SyntheticDrawingFormComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        ɵɵelementStart(8, "label", 2);
        ɵɵtext(9, "Tx Cable Loss: ");
        ɵɵelementEnd();
        ɵɵelement(10, "input", 5);
        ɵɵelementEnd();
        ɵɵelementStart(11, "div", 1);
        ɵɵelementStart(12, "label", 2);
        ɵɵtext(13, "Tx Antenna Gain: ");
        ɵɵelementEnd();
        ...
        ɵɵelementStart(20, "label", 2);
        ɵɵtext(21, "Rx Antenna Gain: ");
        ɵɵelementEnd();
        ɵɵelement(22, "input", 8);
        ɵɵelementEnd();
        ɵɵelementStart(23, "div", 1);
        ɵɵelementStart(24, "label", 2);
        ɵɵtext(25, "Rx Cable Loss: ");
        ɵɵelementEnd();
        ...
        ɵɵlistener("click", function SyntheticDrawingFormComponent_Template_button_click_29_listener() { return ctx.onSubmit(); });
        ɵɵtext(30, " Update Graph ");
        ɵɵelementEnd();
        ɵɵelementEnd();
        ɵɵelementStart(31, "div", 11);
        ɵɵelementStart(32, "button", 13);
        ɵɵlistener("click", function SyntheticDrawingFormComponent_Template_button_click_32_listener() { return ctx.randomizeInputs(); });
        ɵɵtext(33, " Random values ");
        ɵɵelementEnd();
        ɵɵelementEnd();
        ɵɵelementEnd();
        ɵɵelementEnd();
    } if (rf & 2) {
        ɵɵproperty("formGroup", ctx.drawingForm);
    } }, directives: [ɵangular_packages_forms_forms_ba, NgControlStatusGroup, FormGroupDirective, DefaultValueAccessor, NumberValueAccessor, NgControlStatus, FormControlName, FormArrayName], styles: [".ng-valid.required[_ngcontent-%COMP%], .ng-valid[required][_ngcontent-%COMP%]{border-left:5px solid green}.ng-invalid[_ngcontent-%COMP%]:not(form){border-left:5px solid red}"] });
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵsetClassMetadata(SyntheticDrawingFormComponent, [{
        type: Component,
        args: [{
    ...
    }], function () { return [{ type: FormBuilder }, { type: SyntheticDrawingFormService }]; }, { scenarioId: [{
            type: Input
        }] }); })();

class SyntheticDrawingModule {
}
SyntheticDrawingModule.ɵfac = function SyntheticDrawingModule_Factory(t) { return new (t || SyntheticDrawingModule)(); };
SyntheticDrawingModule.ɵmod = ɵɵdefineNgModule({ type: SyntheticDrawingModule });
SyntheticDrawingModule.ɵinj = ɵɵdefineInjector({ providers: [
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵɵsetNgModuleScope(SyntheticDrawingModule, { declarations: [SyntheticDrawingFormComponent,
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵsetClassMetadata(SyntheticDrawingModule, [{
        type: NgModule,
        args: [{
                declarations: [
...
class ResultSidebarModule {
}
ResultSidebarModule.ɵfac = function ResultSidebarModule_Factory(t) { return new (t || ResultSidebarModule)(); };
ResultSidebarModule.ɵmod = ɵɵdefineNgModule({ type: ResultSidebarModule });
ResultSidebarModule.ɵinj = ɵɵdefineInjector({ imports: [[
            CommonModule,
            FontAwesomeModule,
            RouterModule,
            FormsModule,
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵɵsetNgModuleScope(ResultSidebarModule, { declarations: [ResultSidebarComponent,
        ResultsComponent], imports: [CommonModule,
        FontAwesomeModule,
        RouterModule,
        FormsModule, LoggerModule, CardModule,
        SyntheticDrawingModule,
        NavigationSidebarModule], exports: [ResultSidebarComponent,
        ResultsComponent] }); })();
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵsetClassMetadata(ResultSidebarModule, [{
        type: NgModule,
        args: [{
                declarations: [
...
SynthesisComponent.ɵcmp = ɵɵdefineComponent({ type: SynthesisComponent, selectors: [["lib-synthesis"]], decls: 8, vars: 3, consts: [[1, "section"], [1, "columns", "is-multiline", "is-centered"], [1, "column", "is-two-third-desktop"], [3, "scenarioId"], [1, "column", "is-one-third-desktop"], [3, "title"]], template: function SynthesisComponent_Template(rf, ctx) { if (rf & 1) {
        ɵɵelementStart(0, "section", 0);
        ɵɵelementStart(1, "div", 1);
        ɵɵelementStart(2, "div", 2);
        ɵɵelementStart(3, "lib-card");
        ɵɵelement(4, "lib-synthetic-drawing", 3);
        ɵɵelementEnd();
        ɵɵelementEnd();
        ɵɵelementStart(5, "div", 4);
        ɵɵelementStart(6, "lib-card", 5);
        ɵɵelement(7, "lib-synthetic-drawing-form", 3);
        ɵɵelementEnd();
        ɵɵelementEnd();
        ɵɵelementEnd();
        ɵɵelementEnd();
        ...
        ɵɵadvance(4);
        ɵɵproperty("scenarioId", "default");
        ɵɵadvance(2);
        ɵɵproperty("title", "Input values");
        ɵɵadvance(1);
        ɵɵproperty("scenarioId", "default");
    } }, directives: [CardComponent, SyntheticDrawingComponent, SyntheticDrawingFormComponent], styles: [""] });
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵsetClassMetadata(SynthesisComponent, [{
        type: Component,
        args: [{
...
function WelcomeComponent_option_43_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵɵproperty("ngValue", satellite_r6);
    ɵɵadvance(1);
    ɵɵtextInterpolate1(" ", satellite_r6.name, "");
} }
function WelcomeComponent_option_49_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵɵproperty("ngValue", station_r7);
    ɵɵadvance(1);
    ɵɵtextInterpolate1(" ", station_r7.name, " ");
} }
function WelcomeComponent_div_61_Template(rf, ctx) { if (rf & 1) {
    ɵɵelementStart(0, "div");
    ɵɵelementStart(1, "p");
    ɵɵelementStart(2, "b");
    ɵɵtext(3, "Semi-Major Axis (SMA):");
    ɵɵelementEnd();
    ɵɵtext(4);
    ɵɵelementEnd();
    ɵɵelementStart(5, "p");
    ɵɵelementStart(6, "b");
    ɵɵtext(7, "Excentricity:");
    ɵɵelementEnd();
    ɵɵtext(8);
    ɵɵelementEnd();
    ɵɵelementStart(9, "p");
    ...
    const ctx_r3 = ɵɵnextContext();
    ɵɵadvance(4);
    ɵɵtextInterpolate1(" ", ctx_r3.selectedSatellite.sma.toPrecision(3), "");
    ɵɵadvance(4);
    ɵɵtextInterpolate1(" ", ctx_r3.selectedSatellite.ecc, "");
    ɵɵadvance(3);
    ɵɵtextInterpolate1("Minimum Altitude: ", ((1 - ctx_r3.selectedSatellite.ecc) * ctx_r3.selectedSatellite.sma).toPrecision(3), " km");
    ɵɵadvance(3);
    ɵɵtextInterpolate1("Maximum Altitude (imported into geometry): ", ((1 + ctx_r3.selectedSatellite.ecc) * ctx_r3.selectedSatellite.sma).toPrecision(3), " km");
} }
function WelcomeComponent_div_67_Template(rf, ctx) { if (rf & 1) {
    ...
    const ctx_r4 = ɵɵnextContext();
    ɵɵadvance(4);
    ɵɵtextInterpolate1(" ", ctx_r4.selectedStation.elevation.toPrecision(3), "");
} }
function WelcomeComponent_div_68_Template(rf, ctx) { if (rf & 1) {
    ɵɵelementStart(0, "div", 13);
    ɵɵelementStart(1, "lib-card", 6);
    ɵɵelementStart(2, "div", 30);
    ɵɵelement(3, "nano-dropdown-project");
    ɵɵelement(4, "nano-input-id");
    ɵɵelementEnd();
    ɵɵelementEnd();
    ɵɵelementEnd();
} if (rf & 2) {
    ɵɵadvance(1);
    ɵɵproperty("title", "Import from Nanospace");
} }
...
WelcomeComponent.ɵcmp = ɵɵdefineComponent({ type: WelcomeComponent, selectors: [["lib-welcome"]], decls: 69, vars: 18, consts: [[1, "columns"], [1, "column", "is-narrow", 3, "currentComponent"], [1, "column", "pl-0", "pr-5"], [1, "pt-3"], [1, "columns", "is-centered"], [1, "column", "is-two-thirds"], [3, "title"], [2, "display", "flex", "justify-content", "space-around", "align-items", "center"], [1, "button", "is-primary"], [1, "file-input"], ["id", "file", "type", "file", "accept", ".jso", 1, "file", 3, "change"], ["file", ""], [2, "text-align", "center"], [1, "column"], [1, "form", 3, "formGroup", "ngSubmit"], [1, "field", "is-horizontal"], [1, "field-body"], [1, "field"], [1, "label"], [1, "select", "is-fullwidth"], ["formControlName", "satellite"], [3, "ngValue", 4, "ngFor", "ngForOf"], [1, "field", "is-expanded"], ["formControlName", "station"], [1, "field", "is-grouped", "is-grouped-right"], [1, "control"], ["type", "submit", 1, "button", "is-primary"], [4, "ngIf"], ["class", "column", 4, "ngIf"], [3, "ngValue"], [2, "display", "inline-flex"]], template: function WelcomeComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        ɵɵelementStart(4, "h2");
        ɵɵtext(5, "Welcome to Luplink");
        ɵɵelementEnd();
        ɵɵelementStart(6, "p");
        ɵɵtext(7, "Start importing data from JSatOrb or use default data to compute a link budget!");
        ɵɵelementEnd();
        ...
        ɵɵelementStart(14, "input", 10, 11);
        ɵɵlistener("change", function WelcomeComponent_Template_input_change_14_listener() { ɵɵrestoreView(_r8); const _r0 = ɵɵreference(15); return ctx.importJSatOrbData(_r0.files); });
        ɵɵelementEnd();
        ɵɵelementEnd();
        ɵɵtext(16, " Load JSatOrb file (.jso) ");
        ɵɵelementEnd();
        ɵɵelementStart(17, "div", 12);
        ɵɵelementStart(18, "p");
        ɵɵtext(19, "Imported project: ");
        ɵɵelementStart(20, "b");
        ɵɵtext(21);
        ɵɵelementEnd();
        ɵɵelement(22, "br");
        ɵɵtext(23, "Satellites: ");
        ɵɵelementStart(24, "b");
        ɵɵtext(25);
        ɵɵelementEnd();
        ɵɵelement(26, "br");
        ɵɵtext(27, "Groundstations: ");
        ɵɵelementStart(28, "b");
        ɵɵtext(29);
        ɵɵelementEnd();
        ɵɵelementEnd();
        ...
        ɵɵelementEnd();
        ɵɵelementEnd();
        ɵɵelementStart(30, "lib-card", 6);
        ɵɵelementStart(31, "div", 13);
        ɵɵelementStart(32, "p");
        ɵɵelementStart(33, "i");
        ɵɵtext(34, "Choose a satellite and a groundstation to import: ");
        ɵɵelementEnd();
        ɵɵelementEnd();
        ɵɵelementStart(35, "form", 14);
        ɵɵlistener("ngSubmit", function WelcomeComponent_Template_form_ngSubmit_35_listener() { return ctx.useSelectedData(); });
        ...
        ɵɵtemplate(43, WelcomeComponent_option_43_Template, 2, 2, "option", 21);
        ɵɵelementEnd();
        ɵɵelementEnd();
        ɵɵelementEnd();
        ...
        ɵɵelementStart(48, "select", 23);
        ɵɵtemplate(49, WelcomeComponent_option_49_Template, 2, 2, "option", 21);
        ɵɵelementEnd();
        ɵɵelementEnd();
        ɵɵelementEnd();
        ɵɵelementEnd();
        ...
        ɵɵtext(57, "Selected Satellite:");
        ɵɵelementEnd();
        ɵɵelementStart(58, "pre");
        ɵɵtext(59);
        ɵɵpipe(60, "json");
        ɵɵelementEnd();
        ɵɵtemplate(61, WelcomeComponent_div_61_Template, 15, 4, "div", 27);
        ɵɵelementStart(62, "h3");
        ɵɵtext(63, "Selected groundstation");
        ɵɵelementEnd();
        ɵɵelementStart(64, "pre");
        ɵɵtext(65);
        ɵɵpipe(66, "json");
        ɵɵelementEnd();
        ɵɵtemplate(67, WelcomeComponent_div_67_Template, 5, 1, "div", 27);
        ɵɵelementEnd();
        ɵɵelementEnd();
        ɵɵtemplate(68, WelcomeComponent_div_68_Template, 5, 1, "div", 28);
        ɵɵelementEnd();
        ɵɵelementEnd();
        ɵɵelementEnd();
        ɵɵelementEnd();
        ...
        ɵɵadvance(1);
        ɵɵproperty("currentComponent", "welcome");
        ɵɵadvance(9);
        ɵɵproperty("title", "Import data from JSatOrb");
        ɵɵadvance(11);
        ɵɵtextInterpolate(ctx.jsoData.title);
        ɵɵadvance(4);
        ɵɵtextInterpolate1("(", ctx.jsoData.satellites == null ? null : ctx.jsoData.satellites.length, ")");
        ɵɵadvance(4);
        ɵɵtextInterpolate1("(", ctx.jsoData.groundStations == null ? null : ctx.jsoData.groundStations.length, ")");
        ɵɵadvance(1);
        ɵɵproperty("title", "Satellite & Groundstation selection");
        ɵɵadvance(5);
        ɵɵproperty("formGroup", ctx.jsoForm);
        ɵɵadvance(8);
        ɵɵproperty("ngForOf", ctx.jsoData.satellites);
        ɵɵadvance(6);
        ɵɵproperty("ngForOf", ctx.jsoData.groundStations);
        ɵɵadvance(10);
        ɵɵtextInterpolate(ɵɵpipeBind1(60, 14, ctx.selectedSatellite));
        ɵɵadvance(2);
        ɵɵproperty("ngIf", ctx.selectedSatellite);
        ɵɵadvance(4);
        ɵɵtextInterpolate(ɵɵpipeBind1(66, 16, ctx.selectedStation));
        ɵɵadvance(2);
        ɵɵproperty("ngIf", ctx.selectedStation);
        ɵɵadvance(1);
        ɵɵproperty("ngIf", ctx.environment.enableNanospace);
    } }, directives: [NavigationSidebarComponent, CardComponent, ɵangular_packages_forms_forms_ba, NgControlStatusGroup, FormGroupDirective, SelectControlValueAccessor, NgControlStatus, FormControlName, NgForOf, NgIf, NgSelectOption, ɵangular_packages_forms_forms_z, ɵd, ɵg], pipes: [JsonPipe], styles: [""] });
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵsetClassMetadata(WelcomeComponent, [{
        type: Component,
        args: [{
                ...
                type: Inject,
                args: [ENVIRONMENT_TOKEN]
            }] }, { type: LoggerService }, { type: SaveLoadService }, { type: FormService }, { type: FormBuilder }]; }, null); })();
...
ViewComponent.ɵcmp = ɵɵdefineComponent({ type: ViewComponent, selectors: [["lib-view"]], decls: 1, vars: 0, template: function ViewComponent_Template(rf, ctx) { if (rf & 1) {
        ɵɵelement(0, "router-outlet");
    } }, directives: [RouterOutlet], styles: [""] });
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵsetClassMetadata(ViewComponent, [{
        type: Component,
        args: [{
                selector: 'lib-view',
...
LayoutModule.ɵinj = ɵɵdefineInjector({ providers: [
        JSatOrbLinkService,
    ], imports: [[
            CommonModule,
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵɵsetNgModuleScope(LayoutModule, { declarations: [LayoutComponent,
        ViewComponent,
        JSatOrbLinkComponent], imports: [CommonModule, RouterModule, CardModule,
        FormModule,
        LoggerModule,
        SimpleDocumentationModule,
        StepbarModule,
...
const _c0$8 = ["titleInput"];
function NavbarComponent_strong_41_Template(rf, ctx) { if (rf & 1) {
    ɵɵelementStart(0, "strong", 31);
    ɵɵtext(1);
    ɵɵelementEnd();
} if (rf & 2) {
    const ctx_r2 = ɵɵnextContext();
    ɵɵadvance(1);
    ɵɵtextInterpolate2("", ctx_r2.formService.title, "", !ctx_r2.formService.isCurrentFormSaved ? "*" : "", "");
} }
function NavbarComponent_strong_69_Template(rf, ctx) { if (rf & 1) {
    ...
    const ctx_r6 = ɵɵnextContext();
    ɵɵadvance(1);
    ɵɵtextInterpolate2("", ctx_r6.formService.title, "", !ctx_r6.formService.isCurrentFormSaved ? "*" : "", "");
} }
const _c1$3 = function (a0) { return { "is-active": a0 }; };
const _c2$1 = function (a0) { return { "is-hidden": a0 }; };
const _c3$1 = function (a0) { return { "is-loading": a0 }; };
const _c4$1 = ["*"];
...
NavbarComponent.ɵfac = function NavbarComponent_Factory(t) { return new (t || NavbarComponent)(ɵɵdirectiveInject(ENVIRONMENT_TOKEN), ɵɵdirectiveInject(SaveLoadService), ɵɵdirectiveInject(ComputeLinkBudgetService), ɵɵdirectiveInject(FormService), ɵɵdirectiveInject(LoggerService)); };
NavbarComponent.ɵcmp = ɵɵdefineComponent({ type: NavbarComponent, selectors: [["lib-navbar"]], viewQuery: function NavbarComponent_Query(rf, ctx) { if (rf & 1) {
        ɵɵviewQuery(_c0$8, 1);
    } if (rf & 2) {
        let _t;
        ...
        ɵɵlistener("click", function NavbarComponent_Template_span_click_4_listener() { return ctx.isMenuBarVisible = !ctx.isMenuBarVisible; });
        ɵɵelement(5, "span", 4);
        ɵɵelement(6, "span", 4);
        ɵɵelement(7, "span", 4);
        ɵɵelementEnd();
        ...
        ɵɵtext(13, " Simple Link Budget ");
        ɵɵelementEnd();
        ɵɵelementStart(14, "div", 8);
        ɵɵelementStart(15, "a", 2);
        ɵɵtext(16, "New Link Budget");
        ɵɵelementEnd();
        ɵɵelementStart(17, "a", 9);
        ɵɵlistener("click", function NavbarComponent_Template_a_click_17_listener() { return ctx.logger.developer = !ctx.logger.developer; });
        ɵɵtext(18, " Developer mode ");
        ɵɵelementStart(19, "input", 10);
        ɵɵlistener("ngModelChange", function NavbarComponent_Template_input_ngModelChange_19_listener($event) { return ctx.logger.developer = $event; });
        ɵɵelementEnd();
        ɵɵelementEnd();
        ɵɵelementStart(20, "a", 11);
        ɵɵlistener("click", function NavbarComponent_Template_a_click_20_listener() { return ctx.isNanospaceEnabled = !ctx.isNanospaceEnabled; });
        ɵɵtext(21, " Enable Nanospace ");
        ɵɵelementStart(22, "input", 12);
        ɵɵlistener("ngModelChange", function NavbarComponent_Template_input_ngModelChange_22_listener($event) { return ctx.isNanospaceEnabled = $event; });
        ɵɵelementEnd();
        ɵɵelementEnd();
        ɵɵelement(23, "hr", 13);
        ɵɵelementStart(24, "a", 14);
        ɵɵlistener("click", function NavbarComponent_Template_a_click_24_listener() { return ctx.save(); });
        ɵɵtext(25, "Save");
        ɵɵelementEnd();
        ɵɵelementStart(26, "a", 2);
        ɵɵelementStart(27, "div", 15);
        ɵɵelementStart(28, "input", 16, 17);
        ɵɵlistener("change", function NavbarComponent_Template_input_change_28_listener() { ɵɵrestoreView(_r8); const _r0 = ɵɵreference(29); return ctx.load(_r0.files); });
        ɵɵelementEnd();
        ɵɵelementStart(30, "label", 18);
        ɵɵtext(31, "Import");
        ɵɵelementEnd();
        ɵɵelementEnd();
        ɵɵtext(32, " Load ");
        ɵɵelementEnd();
        ɵɵelementStart(33, "a", 2);
        ɵɵelementStart(34, "input", 16, 17);
        ɵɵlistener("change", function NavbarComponent_Template_input_change_34_listener() { ɵɵrestoreView(_r8); const _r0 = ɵɵreference(29); return ctx.load(_r0.files); });
        ɵɵelementEnd();
        ɵɵelementEnd();
        ɵɵelementEnd();
        ɵɵelementEnd();
        ...
        ɵɵlistener("click", function NavbarComponent_Template_a_click_39_listener() { return ctx.editTitle(); });
        ɵɵelement(40, "fa-icon", 22);
        ɵɵtemplate(41, NavbarComponent_strong_41_Template, 2, 2, "strong", 23);
        ɵɵelementStart(42, "input", 24, 25);
        ɵɵlistener("focusout", function NavbarComponent_Template_input_focusout_42_listener($event) { return ctx.onBlur($event); });
        ɵɵelementEnd();
        ɵɵelementEnd();
        ɵɵelementStart(44, "div", 26);
        ɵɵelementStart(45, "a", 2);
        ɵɵtext(46, "New Link Budget");
        ɵɵelementEnd();
        ɵɵelementStart(47, "a", 9);
        ɵɵlistener("click", function NavbarComponent_Template_a_click_47_listener() { return ctx.logger.developer = !ctx.logger.developer; });
        ɵɵtext(48, " Developer mode ");
        ɵɵelementStart(49, "input", 10);
        ɵɵlistener("ngModelChange", function NavbarComponent_Template_input_ngModelChange_49_listener($event) { return ctx.logger.developer = $event; });
        ɵɵelementEnd();
        ɵɵelementEnd();
        ɵɵelementStart(50, "a", 11);
        ɵɵlistener("click", function NavbarComponent_Template_a_click_50_listener() { return ctx.isNanospaceEnabled = !ctx.isNanospaceEnabled; });
        ɵɵtext(51, " Enable Nanospace ");
        ɵɵelementStart(52, "input", 12);
        ɵɵlistener("ngModelChange", function NavbarComponent_Template_input_ngModelChange_52_listener($event) { return ctx.isNanospaceEnabled = $event; });
        ɵɵelementEnd();
        ɵɵelementEnd();
        ɵɵelement(53, "hr", 13);
        ɵɵelementStart(54, "a", 14);
        ɵɵlistener("click", function NavbarComponent_Template_a_click_54_listener() { return ctx.save(); });
        ɵɵtext(55, "Save");
        ɵɵelementEnd();
        ɵɵelementStart(56, "a", 2);
        ɵɵelementStart(57, "div", 15);
        ɵɵelementStart(58, "input", 16, 17);
        ɵɵlistener("change", function NavbarComponent_Template_input_change_58_listener() { ɵɵrestoreView(_r8); const _r0 = ɵɵreference(29); return ctx.load(_r0.files); });
        ɵɵelementEnd();
        ...
        ɵɵtext(62, " Load ");
        ɵɵelementEnd();
        ɵɵelementStart(63, "a", 2);
        ɵɵelementStart(64, "input", 16, 17);
        ɵɵlistener("change", function NavbarComponent_Template_input_change_64_listener() { ɵɵrestoreView(_r8); const _r0 = ɵɵreference(29); return ctx.load(_r0.files); });
        ɵɵelementEnd();
        ɵɵelementEnd();
        ɵɵelementEnd();
        ɵɵelementEnd();
        ...
        ɵɵlistener("click", function NavbarComponent_Template_a_click_67_listener() { return ctx.editTitle(); });
        ɵɵelement(68, "fa-icon", 22);
        ɵɵtemplate(69, NavbarComponent_strong_69_Template, 2, 2, "strong", 23);
        ɵɵelementStart(70, "input", 24, 25);
        ɵɵlistener("focusout", function NavbarComponent_Template_input_focusout_70_listener($event) { return ctx.onBlur($event); });
        ɵɵelementEnd();
        ɵɵelementEnd();
        ɵɵelementEnd();
        ɵɵelementStart(72, "div", 2);
        ɵɵelementStart(73, "div", 29);
        ɵɵelementStart(74, "a", 30);
        ɵɵlistener("click", function NavbarComponent_Template_a_click_74_listener() { return ctx.compute(); });
        ...
        ɵɵadvance(4);
        ɵɵproperty("ngClass", ɵɵpureFunction1(17, _c1$3, ctx.isMenuBarVisible));
        ɵɵadvance(4);
        ɵɵproperty("ngClass", ɵɵpureFunction1(19, _c1$3, ctx.isMenuBarVisible));
        ɵɵadvance(2);
        ɵɵproperty("routerLink", "/luplink/diagram");
        ɵɵadvance(2);
        ɵɵproperty("routerLink", "/luplink");
        ɵɵadvance(7);
        ɵɵproperty("ngModel", ctx.logger.developer);
        ɵɵadvance(3);
        ɵɵproperty("ngModel", ctx.isNanospaceEnabled);
        ɵɵadvance(18);
        ɵɵproperty("icon", ctx.pencil);
        ɵɵadvance(1);
        ɵɵproperty("ngIf", !ctx.isEditingTitle);
        ɵɵadvance(1);
        ɵɵpropertyInterpolate("value", ctx.formService.title);
        ɵɵproperty("ngClass", ɵɵpureFunction1(21, _c2$1, !ctx.isEditingTitle));
        ɵɵadvance(7);
        ɵɵproperty("ngModel", ctx.logger.developer);
        ɵɵadvance(3);
        ɵɵproperty("ngModel", ctx.isNanospaceEnabled);
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵsetClassMetadata(NavbarComponent, [{
        ...
        args: [{
                ...
                type: Inject,
                args: [ENVIRONMENT_TOKEN]
            }] }, { type: SaveLoadService }, { type: ComputeLinkBudgetService }, { type: FormService }, { type: LoggerService }]; }, { titleInput: [{
            type: ViewChild,
            args: ['titleInput']
        }] }); })();
...
NavbarModule.ɵinj = ɵɵdefineInjector({ imports: [[
            CommonModule,
            FormsModule,
            FontAwesomeModule,
            RouterModule,
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵɵsetNgModuleScope(NavbarModule, { declarations: [NavbarComponent], imports: [CommonModule,
        FormsModule,
        FontAwesomeModule,
        RouterModule,
        FormsModule,
        LoggerModule], exports: [NavbarComponent] }); })();
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵsetClassMetadata(NavbarModule, [{
        type: NgModule,
        args: [{
                declarations: [
                    NavbarComponent,
...
SynthesisModule.ɵmod = ɵɵdefineNgModule({ type: SynthesisModule });
SynthesisModule.ɵinj = ɵɵdefineInjector({ imports: [[
            CommonModule,
            FontAwesomeModule,
            CardModule,
            SyntheticDrawingModule,
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵɵsetNgModuleScope(SynthesisModule, { declarations: [SynthesisComponent], imports: [CommonModule,
        FontAwesomeModule,
        CardModule,
        SyntheticDrawingModule, LoggerModule], exports: [SynthesisComponent] }); })();
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵsetClassMetadata(SynthesisModule, [{
        type: NgModule,
        args: [{
                declarations: [
                    SynthesisComponent,
...
WelcomeModule.ɵmod = ɵɵdefineNgModule({ type: WelcomeModule });
WelcomeModule.ɵinj = ɵɵdefineInjector({ providers: [
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵɵsetNgModuleScope(WelcomeModule, { declarations: [WelcomeComponent], imports: [CommonModule,
        ReactiveFormsModule,
        FontAwesomeModule, LoggerModule, FormModule,
        CardModule,
        NavigationSidebarModule,
        NgxNanospaceClientLibModule], exports: [WelcomeComponent] }); })();
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵsetClassMetadata(WelcomeModule, [{
        type: NgModule,
        args: [{
                declarations: [
                    WelcomeComponent,
...
LuplinkModule.ɵmod = ɵɵdefineNgModule({ type: LuplinkModule });
LuplinkModule.ɵinj = ɵɵdefineInjector({ providers: [ComputeLinkBudgetService, SaveLoadService, NanospaceService, NanospaceRequestService], imports: [[CommonModule, FormsModule, CardModule, HttpClientModule, NgxNanospace]] });
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵɵsetNgModuleScope(LuplinkModule, { imports: [CommonModule, FormsModule, CardModule, HttpClientModule, NgxNanospaceClientLibModule] }); })();
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵsetClassMetadata(LuplinkModule, [{
        type: NgModule,
        args: [{
                declarations: [],
...
MockToastPackage.ɵprov = ɵɵdefineInjectable({ token: MockToastPackage, factory: MockToastPackage.ɵfac });
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵsetClassMetadata(MockToastPackage, [{
        type: Injectable
    }], function () { return []; }, null); })();
class ToastrTestingModule {
}
ToastrTestingModule.ɵfac = function ToastrTestingModule_Factory(t) { return new (t || ToastrTestingModule)(); };
ToastrTestingModule.ɵmod = ɵɵdefineNgModule({ type: ToastrTestingModule });
ToastrTestingModule.ɵinj = ɵɵdefineInjector({ providers: [{ provide: ToastPackage, useClass: MockToastPackage }], imports: [[ToastrModule.forRoot()], ToastrModule] });
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵɵsetNgModuleScope(ToastrTestingModule, { imports: [ToastrModule], exports: [ToastrModule] }); })();
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵsetClassMetadata(ToastrTestingModule, [{
        type: NgModule,
        args: [{
...
export { CardComponent, CardModule, EmptyForm, FormComponent, FormModule, JSatOrbLinkComponent, JSatOrbLinkService, LayoutComponent, LayoutModule, LinkBudgetScenario, LogEntry, LogLevel, LoggerModule, LoggerService, LuplinkModule, MockComputeService, MockFormService, MockupLoggerService, NavbarComponent, NavbarModule, NavigationSidebarComponent, NavigationSidebarModule, ResultSidebarComponent, ResultSidebarModule, ResultsComponent, SimpleDocumentationComponent, SimpleDocumentationModule, StepbarComponent, StepbarModule, SynthesisComponent, SynthesisModule, SyntheticDrawingComponent, SyntheticDrawingFormComponent, SyntheticDrawingModule, ToastrTestingModule, ViewComponent, WelcomeComponent, WelcomeModule, mockEnvironment };
//# sourceMappingURL=luplink-ngx-luplink.js.map
