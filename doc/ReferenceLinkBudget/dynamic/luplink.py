...
#            return stations_OEM
    ...
    def compute_uplink_losses(self):
        if self.verbose: 
            print("#transmitter_losses :"+str(self.compute_uplink_transmitter_losses()))
            print("#path_losses :"+str(self.compute_uplink_path_losses()))
            print("#receiver_losses :"+str(self.compute_uplink_receiver_losses()))
    ...
    def computeC_N0_uplink(self):
        ...
        if self.verbose: print("gain_r (dBi):"+str(gain_r_dB))
        #r_iso_power = P_t_dB + gain_tx_dB - losses + self.compute_uplink_receiver_losses()
        #if self.verbose: print("#isotropic@SC"+str(r_iso_power))
        c_n0 = P_t_dB + gain_tx_dB + gain_r_dB - losses - k_dB - T_r_dB
        return c_n0
